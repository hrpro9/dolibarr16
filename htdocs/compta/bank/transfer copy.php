...
function GenerateDocuments()
{
  ...
  <input type="hidden" id="btngen" class="button" name="save" value="génerer">';
  print '</form>';
}
...
// echo '<h1 style="text-align: center; margin-bottom: 150px; font-size: 30px;">
...
print '<br><div class="center"><input type="submit" class="button" value="'.$langs->trans("Create").'" onclick="'.GenerateDocuments().'"></div>';
