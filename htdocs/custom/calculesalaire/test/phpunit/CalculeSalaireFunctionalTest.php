...
/**
 * \file    test/phpunit/CalculeSalaireFunctionalTest.php
...
/**
 * Class CalculeSalaireFunctionalTest
 *
 ...
 *
 * @package Testcalculesalaire
 */
class CalculeSalaireFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCalculeSalaire')->click();
		} else {
			// Disable the module
			$this->byHref('modCalculeSalaire')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/calculesalaire/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('calculesalaire/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/calculesalaire/admin/about.php');
		$this->authenticate();
		return $this->assertContains('calculesalaire/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('calculesalairewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCalculeSalaire_CalculeSalaireTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCalculeSalaire_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
