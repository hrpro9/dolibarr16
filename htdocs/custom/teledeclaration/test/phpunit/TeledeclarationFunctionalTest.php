...
/**
 * \file    test/phpunit/TeledeclarationFunctionalTest.php
...
/**
 * Class TeledeclarationFunctionalTest
 *
 ...
 *
 * @package Testteledeclaration
 */
class TeledeclarationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTeledeclaration')->click();
		} else {
			// Disable the module
			$this->byHref('modTeledeclaration')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/teledeclaration/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('teledeclaration/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/teledeclaration/admin/about.php');
		$this->authenticate();
		return $this->assertContains('teledeclaration/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('teledeclarationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTeledeclaration_TeledeclarationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTeledeclaration_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
