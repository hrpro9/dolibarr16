        ...
        <div class="col-lg-4 m-auto">
            <form method="post" enctype="multipart/form-data">
                <ul class="form-style-1" style="text-align: center;">
                    <h4 style="text-align: center;" class="field-divided">Declaration CNSS !</h4>
                    <li>
            ...
            if (isset($_POST['read_file'])) {
                ...
                while (!feof($file)) {
                    ...
                    if(!empty($a) && !empty($n_num_affilie) && !empty($annee) && !empty($mois) && !empty($date) && !empty($ncnss) && !empty($nom_prenom) && !empty($n_enfants) && !empty($n_af_a_payer) && !empty($n_af_a_deduire)){
            ...
            ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo  $user['n_af_a_deduire'];
                                        ?>
                                    </td>
                                    <td>
                                        <?php
                                        echo  $AF_A_Net_Payer = $cf - $user['n_af_a_deduire'];
                                        ?>
                                    </td>
                                    <td>0</td>
                                    <td>
                ...
                if (isset($_POST['Generer'])) {
                    ...
                    foreach ($rest_cnss as $user) {
                        ...
                        $param = ((object)($rest_ef))->fetch_assoc();
                        //n_num_affilie
                        $n_num_affilie = $user['n_num_affilie'];
                        //l_periode
                        $l_periode = $user['date'];
                        //n_num_assure
                        $n_num_assure = $user['cnss'];
                        //n_nb_salaries
                        $n_nb_salaries++;
                        //n_t_num_immatriculations
                        $x_n_t_num_imm = $n_t_num_imm + $user['cnss'];
                        $n_t_num_imm = $x_n_t_num_imm;
                        //l_nom_prenom
                        $l_nom_prenom = $user['nom_prenom'];
                        //n_enfants
                        ...
                        //n_af_a_deduire
                        $n_af_a_deduire = $user['n_af_a_deduire'];
                        //n_t_af_a_deduire
