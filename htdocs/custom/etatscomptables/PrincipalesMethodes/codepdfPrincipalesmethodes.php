...
class pdf_Principalesmethodes extends ModelePDFUser
{
	/**
	...
	public function write_file($object, $outputlangs = "", $srctemplatepath = "", $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams)
	{
		...
		if (true) {
			...
			if ($object->specimen) {
				...
				$dir = DOL_DATA_ROOT . \'/billanLaisse/Principalesmethodes/\';
			
				$year=GETPOST(\'year\');
			
				$file = $dir . "/Principalesmethodes".$year . ".pdf";
				// $file = $dir . "/Passif.pdf";
			...
			<table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
					...
					<tr class="row2">
						<td class="column0 style11 s">I. ACTIF IMMOBILISE</td>
						<td class="column2 style12 s"></td>
					</tr>
					<tr class="row2">
						<td class="column0 style11 s">A. EVALUATION A L ENTREE</td>
						<td class="column2 style12 s"></td>
					</tr>
					<tr class="row3">
					<td class="column0 style14 null">1. Immobilisation en non-valeurs</td>
					<td class="column0 style14 null">\'.$PrincipalesMethodes0.\'</td>
					</tr>
					<tr class="row3">
					<td class="column0 style14 null">2. Immobilisation incorporelles</td>
					<td class="column0 style14 null">\'.$PrincipalesMethodes1.\'</td>
					</tr>
					<tr class="row3">
					<td class="column0 style14 null">3. Immobilisations corporelles</td>
					<td class="column0 style14 null">\'.$PrincipalesMethodes2.\'</td>
					</tr>
					<tr class="row3">
					<td class="column0 style14 null">4. Immobilisations financières</td>
					<td class="column0 style14 null">\'.$PrincipalesMethodes3.\'</td>
					</tr>
					<tr class="row2">
					<td class="column0 style11 s">B. CORRECTIONS DE VALEUR</td>
					<td class="column2 style12 s"></td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">1. Méthodes d amortissements</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes4.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">2. Méthodes d évaluation des provisions pour dépréciation</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes5.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">3. Méthodes de détermination des écarts de conversion - Actif </td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes6.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">II. ACTIF CIRCULANT (Hors trésorerie)</td>
					<td class="column2 style12 s"></td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">A. EVALUATION A L ENTREE</td>
					...
					<td class="column2 style12 s">\'.$PrincipalesMethodes7.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">2. Créances		</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes8.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">3. Titres et valeurs de placement	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes9.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">B. CORRECTIONS DE VALEUR	</td>
					<td class="column2 style12 s"></td>
					...
					<td class="column2 style12 s">\'.$PrincipalesMethodes10.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">2. Méthodes de détermination des écarts de conversion - Actif	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes11.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">III. FINANCEMENT PERMANENT	</td>
					<td class="column2 style12 s"></td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">1. Méthodes de réévaluation	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes12.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">2. Méthodes d évaluation des provisions réglementées	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes13.\'</td>
				    </tr>	
					<tr class="row2">
					<td class="column0 style11 s">3. Dettes de financement permanent		</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes14.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">4. Méthodes d évaluation des provisions durables pour risques et charges	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes15.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">5. Méthodes de détermination des écarts de conversion - Passif</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes16.\'</td>
				    </tr>
                    <tr class="row2">
					<td class="column0 style11 s">IV. PASSIF CIRCULANT (Hors trésorerie)	</td>
					<td class="column2 style12 s"></td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">1. Dettes du passif circulant	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes17.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">2. Méthodes d évaluation des autres provisions pour risques et charges</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes18.\'</td>
				    </tr>	
					<tr class="row2">
					<td class="column0 style11 s">3. Méthodes de détermination des écarts de conversion - Passif	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes19.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">V. TRESORERIE	</td>
					<td class="column2 style12 s"></td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">1. Trésorerie - Actif		</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes20.\'</td>
				    </tr>
					<tr class="row2">
					<td class="column0 style11 s">2. Trésorerie - Passif	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes21.\'</td>
				    </tr>	
					<tr class="row2">
					<td class="column0 style11 s">3. Méthodes d évaluation des provisions pour dépréciation	</td>
					<td class="column2 style12 s">\'.$PrincipalesMethodes22.\'</td>
				    </tr>
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $totalNet, $periode)
	{
		...
		$pdf->SetFont(\'\', \'B\', $default_font_size + 3);
		$pdf->MultiCell(200, 2, "PRINCIPALES METHODES D EVALUATION SPECIFIQUES A L ENTREPRISE ".$year, 0, "C");
