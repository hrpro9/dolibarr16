<?php
  ...
  if(isset($_POST['register']))
  {
        ...
        // $balanceN=$_POST['balanceN'];
        // $balanceN1=$_POST['balanceN1'];
        // $balanceN2=$_POST['balanceN2']??'';

        // $balanceN=$_FILES['balanceN'];
        // $balanceN1=$_FILES['balanceN1'];
        // $balanceN2=$_FILES['balanceN2']??'';
        ...
        // if (isset($_FILES["balanceN"]) && $_FILES["balanceN"]["error"] === UPLOAD_ERR_OK) {
        //     $nomFichier = $_FILES["balanceN"]["name"];
        //     $nomTemporaire = $_FILES["balanceN"]["tmp_name"];
        //     $chemin = "./uploads/";
        ...
        //     }
        //   } else {
        //     echo 'Aucun fichier sélectionné ou une erreur s\'est produite lors du téléchargement.';
        //   }
       ...
       $nomFichier = 'InfomationSociete_'. $annee.'.php';
       // Écrire les données dans le nouveau fichier
       file_put_contents($nomFichier, $data);

       $check= DOL_DOCUMENT_ROOT.'/custom/etatscomptables/declarationLaisseExl/'.$nomFichier;
       ...
       if (file_exists($check)) {
        ...
        echo '<label>
            ...
            echo '<label>
                ...
                <span class="alertClose">X</span>
                <span class="alertText">Échec de l ajout des informations<br class="clear"/></span>
                </div>
            </label>';
        }
...
<body >
        ...
        <div id="dateFields" style="display: none;">
            <div class="form-group">
                <div class="form-row form-row-1">
                    ...
                    <input type="reset" name="anneeDu" id="anneeDu" class="input-text" required>
                </div>
                <div class="form-row form-row-2">
                    <p style="color: #fff">Au</p>
                    <input type="reset" name="anneeAu" id="anneeAu" class="input-text" required>
                </div>
            </div>
        </div>
        <script>
    ...
    <a href="./uploads/SI2310-0002_GPC-002.pdf" download="./uploads/SI2310-0002_GPC-002.pdf">pdf</a>
