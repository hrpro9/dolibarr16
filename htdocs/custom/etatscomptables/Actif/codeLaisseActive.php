...
$total2_B=$total2_AP=$total2_net=$total2_EP=$total2_E2=0;//------------------------------- TOTAL  II   (  f + g + h + i )
  ...
  // {
    ...
    $data .= '$immNonVal_AP = ' . $immNonVal_AP . ";\n";
    $data .= '$immNonVal_net = ' . $immNonVal_net . ";\n";
    $data .= '$immNonVal_EP = ' . $immNonVal_EP . ";\n";
    $data .= '$immNonVal_E2 = ' . $immNonVal_E2 . ";\n";
    $data .= '$fraisP_B = ' . $fraisP_B . ";\n"; 
    $data .= '$fraisP_AP = ' . ($fraisP_AP*-1) . ";\n";
    $data .= '$fraisP_B_fraisP_AP = ' . ($fraisP_B-($fraisP_AP*-1)) . ";\n";
    $data .= '$fraisP_EP = ' . $fraisP_EP . ";\n";
    $data .= '$fraisP_E2 = ' . $fraisP_E2 . ";\n";
    $data .= '$chargesR_B = ' . $chargesR_B . ";\n";
    $data .= '$chargesR_AP = ' . ($chargesR_AP*-1) . ";\n"; 
    $data .= '$chargesR_B_chargesR_AP = ' . ($chargesR_B-($chargesR_AP*-1)) . ";\n";
    $data .= '$chargesR_EP = ' . $chargesR_EP . ";\n";
    $data .= '$chargesR_E2 = ' . $chargesR_E2 . ";\n";
    $data .= '$primesR_B = ' . $primesR_B . ";\n";
    $data .= '$primesR_AP = ' .($primesR_AP*-1) . ";\n"; 
    $data .= '$primesR_B_primesR_AP = ' . ($primesR_B-($primesR_AP*-1)) . ";\n";
    $data .= '$primesR_EP = ' . $primesR_EP . ";\n";
    $data .= '$primesR_E2 = ' . $primesR_E2 . ";\n";
    $data .= '$immIncor_B = ' . $immIncor_B . ";\n";
    $data .= '$immIncor_AP = ' .$immIncor_AP . ";\n"; 
    $data .= '$immIncor_net = ' . $immIncor_net . ";\n";
    $data .= '$immIncor_EP = ' . $immIncor_EP . ";\n";
    $data .= '$immIncor_E2 = ' .$immIncor_E2 . ";\n"; 
    $data .= '$immReche_B = ' . $immReche_B . ";\n";
    $data .= '$immReche_AP = ' . $immReche_AP . ";\n";
    $data .= '$immReche_B_immReche_AP = ' . ($immReche_B-$immReche_AP) . ";\n";
    $data .= '$immReche_EP = ' . $immReche_EP . ";\n";
    $data .= '$immReche_E2 = ' . $immReche_E2 . ";\n";
    $data .= '$BMD_B = ' . $BMD_B . ";\n"; 
    $data .= '$BMD_AP = ' . $BMD_AP . ";\n";
    $data .= '$BMD_B_BMD_AP = ' . ($BMD_B-$BMD_AP) . ";\n";
    $data .= '$BMD_EP = ' . $BMD_EP . ";\n";
    $data .= '$BMD_E2 = ' . $BMD_E2 . ";\n";
    $data .= '$fondsC_B = ' . $fondsC_B . ";\n";
    $data .= '$fondsC_AP = ' . $fondsC_AP . ";\n"; 
    $data .= '$fondsC_B_fondsC_AP = ' . ($fondsC_B-$fondsC_AP) . ";\n";
    $data .= '$fondsC_EP = ' . $fondsC_EP . ";\n";
    $data .= '$fondsC_E2 = ' . $fondsC_E2 . ";\n";
    $data .= '$autresImmoInc_B = ' . $autresImmoInc_B . ";\n";
    $data .= '$autresImmoInc_AP = ' .$autresImmoInc_AP . ";\n"; 
    $data .= '$autresImmoInc_B_autresImmoInc_AP = ' . ($autresImmoInc_B-$autresImmoInc_AP) . ";\n";
    $data .= '$autresImmoInc_EP = ' . $autresImmoInc_EP . ";\n";
    $data .= '$primesR_E2 = ' . $primesR_E2 . ";\n";
    $data .= '$autresImmoInc_E2 = ' . $autresImmoInc_E2 . ";\n";
    $data .= '$immCor_B = ' .$immCor_B . ";\n"; 
    $data .= '$immCor_AP = ' . $immCor_AP . ";\n";
    $data .= '$immCor_net = ' . $immCor_net . ";\n";
    $data .= '$immCor_EP = ' .$immCor_EP . ";\n"; 
    $data .= '$immCor_E2 = ' .$immCor_E2 . ";\n"; 
    $data .= '$terrains_B = ' .$terrains_B . ";\n"; 
    $data .= '$terrains_AP = ' . $terrains_AP . ";\n";
    ...
    $data .= '$instalTechMat_B = ' .$instalTechMat_B . ";\n"; 
    $data .= '$instalTechMat_AP = ' . $instalTechMat_AP . ";\n";
    $data .= '$instalTechMat_B_instalTechMat_AP = ' .($instalTechMat_B-$instalTechMat_AP). ";\n";
    $data .= '$instalTechMat_EP = ' .$instalTechMat_EP . ";\n"; 
    $data .= '$instalTechMat_E2 = ' .$instalTechMat_E2 . ";\n"; 
    $data .= '$matTransp_B = ' .$matTransp_B . ";\n"; 
    $data .= '$matTransp_AP = ' . $matTransp_AP . ";\n";
    $data .= '$matTransp_B_matTransp_AP = ' .($matTransp_B-$matTransp_AP). ";\n";
    $data .= '$matTransp_EP = ' .$matTransp_EP . ";\n"; 
    $data .= '$matTransp_E2 = ' .$matTransp_E2 . ";\n"; 
    $data .= '$mobMatAmenag_B = ' .$mobMatAmenag_B . ";\n"; 
    $data .= '$mobMatAmenag_AP = ' . $mobMatAmenag_AP . ";\n";
    $data .= '$mobMatAmenag_B_BmobMatAmenag_AP = ' .($mobMatAmenag_B-$mobMatAmenag_AP). ";\n";
    $data .= '$mobMatAmenag_EP = ' .$mobMatAmenag_EP . ";\n"; 
    $data .= '$mobMatAmenag_E2 = ' .$mobMatAmenag_E2 . ";\n"; 
    $data .= '$autresImmoCor_B = ' .$autresImmoCor_B . ";\n"; 
    $data .= '$autresImmoCor_AP = ' . $autresImmoCor_AP . ";\n";
    ...
    $data .= '$immFin_B = ' .$immFin_B . ";\n"; 
    $data .= '$immFin_AP = ' . $immFin_AP . ";\n";
    $data .= '$immFin_net = ' .($immFin_net). ";\n";
    $data .= '$immFin_EP = ' .$immFin_EP . ";\n"; 
    $data .= '$immFin_E2 = ' .$immFin_E2 . ";\n"; 
    $data .= '$pretsImm_B = ' .$pretsImm_B . ";\n"; 
    $data .= '$pretsImm_AP = ' . ($pretsImm_AP*-1) . ";\n";
    $data .= '$pretsImm_B_pretsImm_AP = ' .($pretsImm_B-($pretsImm_AP*-1)). ";\n";
    $data .= '$pretsImm_EP = ' .$pretsImm_EP . ";\n"; 
    $data .= '$pretsImm_E2 = ' .$pretsImm_E2 . ";\n"; 
    $data .= '$autresCreFin_B = ' .$autresCreFin_B . ";\n"; 
    $data .= '$autresCreFin_AP = ' . ($autresCreFin_AP*-1) . ";\n";
    $data .= '$autresCreFin_B_autresCreFin_AP = ' .($autresCreFin_B-($autresCreFin_AP*-1)). ";\n";
    $data .= '$autresCreFin_EP = ' .$autresCreFin_EP . ";\n"; 
    $data .= '$autresCreFin_E2 = ' .$autresCreFin_E2 . ";\n"; 
    $data .= '$titresP_B = ' .$titresP_B . ";\n"; 
    $data .= '$titresP_AP = ' . ($titresP_AP*-1). ";\n";
    $data .= '$titresP_B_titresP_AP = ' .($titresP_B-($titresP_AP*-1)). ";\n";
    $data .= '$titresP_EP = ' .$titresP_EP . ";\n"; 
    $data .= '$titresP_E2 = ' .$titresP_E2 . ";\n"; 
    $data .= '$autresTitrImm_B = ' .$autresTitrImm_B . ";\n"; 
    $data .= '$autresTitrImm_AP = ' . ($autresTitrImm_AP*-1). ";\n";
    $data .= '$autresTitrImm_autresTitrImm_AP = ' .($autresTitrImm_B-($autresTitrImm_AP*-1)). ";\n";
    $data .= '$autresTitrImm_EP = ' .$autresTitrImm_EP . ";\n"; 
    $data .= '$autresTitrImm_E2 = ' .$autresTitrImm_E2 . ";\n"; 
    $data .= '$ecratsConv_B = ' .$ecratsConv_B . ";\n"; 
    $data .= '$ecratsConv_net = ' . $ecratsConv_net. ";\n";
    $data .= '$ecratsConv_EP = ' .$ecratsConv_EP. ";\n";
    $data .= '$ecratsConv_E2 = ' .$ecratsConv_E2 . ";\n"; 
    $data .= '$dimCreImm_B = ' .$dimCreImm_B . ";\n";
    $data .= '$dimCreImm_B = ' .$dimCreImm_B. ";\n";
    $data .= '$dimCreImm_EP = ' .$dimCreImm_EP . ";\n"; 
    $data .= '$dimCreImm_E2 = ' .$dimCreImm_E2 . ";\n";
    $data .= '$augDetFinc_B = ' .$augDetFinc_B . ";\n";
    $data .= '$augDetFinc_B = ' .$augDetFinc_B. ";\n";
    $data .= '$augDetFinc_EP = ' .$augDetFinc_EP . ";\n"; 
    $data .= '$augDetFinc_E2 = ' .$augDetFinc_E2 . ";\n";
    $data .= '$total1_B = ' .$total1_B . ";\n";
    $data .= '$total1_AP = ' .$total1_AP . ";\n";
    ...
    $data .= '$march_EP = ' .$march_EP . ";\n"; 
    $data .= '$march_E2 = ' .$march_E2 . ";\n";
    $data .= '$matFournCon_B = ' .$matFournCon_B . ";\n";
    $data .= '$matFournCon_AP = ' .($matFournCon_AP*-1) . ";\n";
    $data .= '$matFournCon_B_matFournCon_AP = ' .($matFournCon_B-($matFournCon_AP*-1)). ";\n";
    $data .= '$matFournCon_EP = ' .$matFournCon_EP . ";\n"; 
    $data .= '$matFournCon_E2 = ' .$matFournCon_E2 . ";\n";
    $data .= '$prodC_B = ' .$prodC_B . ";\n";
    $data .= '$prodC_AP = ' .($prodC_AP*-1) . ";\n";
    $data .= '$prodC_B_prodC_AP = ' .($prodC_B-($prodC_AP*-1)). ";\n";
    $data .= '$prodC_EP = ' .$prodC_EP . ";\n"; 
    $data .= '$prodC_E2 = ' .$prodC_E2 . ";\n";
    $data .= '$prodIntrProd_B = ' .$prodIntrProd_B . ";\n";
    $data .= '$prodIntrProd_AP = ' .($prodIntrProd_AP*-1) . ";\n";
    $data .= '$prodIntrProd_B_prodIntrProd_AP = ' .($prodIntrProd_B-($prodIntrProd_AP*-1)). ";\n";
    $data .= '$prodIntrProd_EP = ' .$prodIntrProd_EP . ";\n"; 
    $data .= '$prodIntrProd_E2 = ' .$prodIntrProd_E2 . ";\n";
    $data .= '$prodFinis_B = ' .$prodFinis_B . ";\n";
    $data .= '$prodFinis_AP = ' .($prodFinis_AP*-1) . ";\n";
    $data .= '$prodFinis_B_prodFinis_AP = ' .($prodFinis_B-($prodFinis_AP*-1)). ";\n";
    $data .= '$prodFinis_EP = ' .$prodFinis_EP . ";\n"; 
    $data .= '$prodFinis_E2 = ' .$prodFinis_E2 . ";\n";
    $data .= '$creActifCircl_B = ' .$creActifCircl_B . ";\n";
    $data .= '$creActifCircl_AP = ' .$creActifCircl_AP . ";\n";
    $data .= '$creActifCircl_net = ' .$creActifCircl_net. ";\n";
    $data .= '$creActifCircl_EP = ' .$creActifCircl_EP . ";\n"; 
    $data .= '$creActifCircl_E2 = ' .$creActifCircl_E2 . ";\n";
    $data .= '$fournDAA_B = ' .$fournDAA_B . ";\n";
    $data .= '$fournDAA_AP = ' .($fournDAA_AP*-1) . ";\n";
    $data .= '$fournDAA_B_fournDAA_AP = ' .($fournDAA_B-($fournDAA_AP*-1)). ";\n";
    $data .= '$fournDAA_EP = ' .$fournDAA_EP . ";\n"; 
    $data .= '$fournDAA_E2 = ' .$fournDAA_E2 . ";\n";
    $data .= '$clientCR_B = ' .$clientCR_B . ";\n";
    $data .= '$clientCR_AP = ' .($clientCR_AP*-1) . ";\n";
    $data .= '$clientCR_B_clientCR_AP = ' .($clientCR_B-($clientCR_AP*-1)). ";\n";
    $data .= '$clientCR_EP = ' .$clientCR_EP . ";\n"; 
    $data .= '$clientCR_E2 = ' .$clientCR_E2 . ";\n";
    $data .= '$persl_B = ' .$persl_B . ";\n";
    $data .= '$persl_AP = ' .($persl_AP*-1) . ";\n";
    $data .= '$persl_B_persl_AP = ' .($persl_B-($persl_AP*-1)). ";\n";
    $data .= '$persl_EP = ' .$persl_EP . ";\n"; 
    $data .= '$persl_E2 = ' .$persl_E2 . ";\n";
    $data .= '$etat_B = ' .$etat_B . ";\n";
    $data .= '$etat_AP = ' .($etat_AP*-1) . ";\n";
    $data .= '$etat_B_etat_AP = ' .($etat_B-($etat_AP*-1)). ";\n";
    $data .= '$etat_EP = ' .$etat_EP . ";\n"; 
    $data .= '$etat_E2 = ' .$etat_E2 . ";\n";
    $data .= '$comptAss_B = ' .$comptAss_B . ";\n";
    $data .= '$comptAss_AP = ' .($comptAss_AP*-1) . ";\n";
    $data .= '$comptAss_B_comptAss_AP = ' .($comptAss_B-($comptAss_AP*-1)). ";\n";
    $data .= '$comptAss_EP = ' .$comptAss_EP . ";\n"; 
    $data .= '$comptAss_E2 = ' .$comptAss_E2 . ";\n";
    $data .= '$autresDebit_B = ' .$autresDebit_B . ";\n";
    $data .= '$autresDebit_AP = ' .($autresDebit_AP*-1) . ";\n";
    $data .= '$autresDebit_B_autresDebit_AP = ' .($autresDebit_B-($autresDebit_AP*-1)). ";\n";
    $data .= '$autresDebit_EP = ' .$autresDebit_EP . ";\n"; 
    $data .= '$autresDebit_E2 = ' .$autresDebit_E2 . ";\n";
    $data .= '$comptRegAct_B = ' .$comptRegAct_B . ";\n";
    $data .= '$comptRegAct_AP = ' .($comptRegAct_AP*-1) . ";\n";
    $data .= '$comptRegAct_B_comptRegAct_AP = ' .($comptRegAct_B-($comptRegAct_AP*-1)). ";\n";
    $data .= '$comptRegAct_EP = ' .$comptRegAct_EP . ";\n"; 
    $data .= '$comptRegAct_E2 = ' .$comptRegAct_E2 . ";\n";
    $data .= '$titreValPlace_B = ' .$titreValPlace_B . ";\n";
    $data .= '$titreValPlace_AP = ' .($titreValPlace_AP*-1) . ";\n";
    $data .= '$titreValPlace_B_titreValPlace_AP = ' .($titreValPlace_B-($titreValPlace_AP*-1)). ";\n";
    $data .= '$titreValPlace_EP = ' .$titreValPlace_EP . ";\n"; 
    $data .= '$titreValPlace_E2 = ' .$titreValPlace_E2 . ";\n";
    $data .= '$ecratConverAct_B = ' .$ecratConverAct_B . ";\n";
    $data .= '$ecratConverAct_B = ' .$ecratConverAct_B . ";\n";
    $data .= '$ecratConverAct_EP = ' .$ecratConverAct_EP. ";\n";
    $data .= '$ecratConverAct_E2 = ' .$ecratConverAct_E2 . ";\n"; 
    $data .= '$total2_B = ' .$total2_B . ";\n";
    $data .= '$total2_AP = ' .$total2_AP . ";\n";
    $data .= '$total2_net = ' .$total2_net. ";\n";
    $data .= '$total2_EP = ' .$total2_EP . ";\n"; 
    $data .= '$total2_E2 = ' .$total2_E2 . ";\n";
    $data .= '$tresorAct_B = ' .$tresorAct_B . ";\n";
    $data .= '$tresorAct_AP = ' .$tresorAct_AP . ";\n";
    ...
    $data .= '$chqValEnc_E2 = ' .$chqValEnc_E2 . ";\n";
    $data .= '$banqTGCP_B = ' .$banqTGCP_B . ";\n";
    $data .= '$banqTGCP_AP = ' .($banqTGCP_AP*-1) . ";\n";
    $data .= '$banqTGCP_B_banqTGCP_AP = ' .($banqTGCP_B-($banqTGCP_AP*-1)). ";\n";
    $data .= '$banqTGCP_EP = ' .$banqTGCP_EP . ";\n"; 
    $data .= '$banqTGCP_E2 = ' .$banqTGCP_E2 . ";\n";
    $data .= '$caissRegAv_B = ' .$caissRegAv_B . ";\n";
    $data .= '$caissRegAv_AP = ' .($caissRegAv_AP*-1) . ";\n";
    $data .= '$caissRegAv_B_caissRegAv_AP = ' .($caissRegAv_B-($caissRegAv_AP*-1)). ";\n";
    $data .= '$caissRegAv_EP = ' .$caissRegAv_EP . ";\n"; 
    $data .= '$caissRegAv_E2 = ' .$caissRegAv_E2 . ";\n";
    $data .= '$total3_B = ' .$total3_B . ";\n";
    $data .= '$total3_AP = ' .$total3_AP . ";\n";
    $data .= '$total3_net = ' .$total3_net. ";\n";
    $data .= '$total3_EP = ' .$total3_EP . ";\n"; 
    $data .= '$total3_E2 = ' .$total3_E2 . ";\n";
    $data .= '$totalGen_B = ' .$totalGen_B . ";\n";
    $data .= '$totalGen_AP = ' .$totalGen_AP . ";\n";
    $data .= '$totalGen_net = ' .$totalGen_net. ";\n";
    $data .= '$totalGen_EP = ' .$totalGen_EP . ";\n"; 
    $data .= '$totalGen_E2 = ' .$totalGen_E2 . ";\n";
  ...
  $data .= "?>";
   ...
   $nomFichier = 'Active_fichier_'. $dateChoisis.'.php';
