<?php
   ...
   if(!isset($_POST['chargement']))
  {
   ...
   foreach($result as $row){
    ...
    $data .= '$prExPaLex = ' . $prExPaLex . ";\n";
    $data .= '$reExTchCLExPr = ' . $reExTchCLExPr . ";\n";
    $data .= '$reExTchToEx = ' . $reExTchToEx . ";\n";
    $data .= '$reExTchExPre = ' . $reExTchExPre . ";\n";
    $data .= '$reExTchExN2 = ' . $reExTchExN2 . ";\n";
    $data .= '$veMarchPaLex = ' . $veMarchPaLex . ";\n";
    $data .= '$veMarchCLExPr = ' . $veMarchCLExPr . ";\n";
    $data .= '$veMarchToEx = ' . $veMarchToEx . ";\n";
    $data .= '$veMarchExPre = ' . $veMarchExPre . ";\n";
    $data .= '$veMarchExN2 = ' . $veMarchExN2 . ";\n";
    $data .= '$venBSPPaLex = ' . $venBSPPaLex . ";\n";
    $data .= '$venBSPCLExPr = ' . $venBSPCLExPr . ";\n";
    $data .= '$venBSPToEx = ' . $venBSPToEx . ";\n";
    $data .= '$venBSPExPre = ' . $venBSPExPre . ";\n";
    $data .= '$venBSPExN2 = ' . $venBSPExN2 . ";\n";
    $data .= '$chAffPaLex = ' . $chAffPaLex . ";\n";
    $data .= '$chAffCLExPr = ' . $chAffCLExPr . ";\n";
    $data .= '$chAffToEx = ' . $chAffToEx . ";\n";
    $data .= '$chAffExPre = ' . $chAffExPre . ";\n";
    $data .= '$chAffExN2 = ' . $chAffExN2 . ";\n";
    $data .= '$varSyProPaLex = ' . $varSyProPaLex . ";\n";
    $data .= '$varSyProCLExPr = ' . $varSyProCLExPr . ";\n";
    $data .= '$varSyProToEx = ' . $varSyProToEx . ";\n";
    $data .= '$varSyProExPre = ' . $varSyProExPre . ";\n";
    $data .= '$varSyProExN2 = ' . $varSyProExN2 . ";\n";
    $data .= '$imPrLePaLex = ' . $imPrLePaLex . ";\n";
    $data .= '$imPrLeCLExPr = ' . $imPrLeCLExPr . ";\n";
    $data .= '$imPrLeToEx = ' . $imPrLeToEx . ";\n";
    $data .= '$imPrLeExPre = ' . $imPrLeExPre . ";\n";
    $data .= '$imPrLeExN2 = ' . $imPrLeExN2 . ";\n";
    $data .= '$subEXPaLex = ' . $subEXPaLex . ";\n";
    $data .= '$subEXCLExPr = ' . $subEXCLExPr . ";\n";
    $data .= '$subEXToEx = ' . $subEXToEx . ";\n";
    $data .= '$subEXExPre = ' . $subEXExPre . ";\n";
    $data .= '$subEXExN2 = ' . $subEXExN2 . ";\n";
    $data .= '$auPrExPaLex = ' . $auPrExPaLex . ";\n";
    $data .= '$auPrExCLExPr = ' . $auPrExCLExPr . ";\n";
    $data .= '$auPrExToEx = ' . $auPrExToEx . ";\n";
    ...
    $data .= '$totalIExPre = ' . $totalIExPre . ";\n";
    $data .= '$totalIExN2 = ' . $totalIExN2 . ";\n";
    $data .= '$achReMPaLex = ' . $achReMPaLex . ";\n";
    $data .= '$achReMCLExPr = ' . $achReMCLExPr . ";\n";
    $data .= '$achReMToEx = ' . $achReMToEx . ";\n";
    $data .= '$achReMExPre = ' . $achReMExPre . ";\n";
    $data .= '$achReMExN2 = ' . $achReMExN2 . ";\n";
    $data .= '$achCMDPaLex = ' . $achCMDPaLex . ";\n";
    $data .= '$achCMDCLExPr = ' . $achCMDCLExPr . ";\n";
    $data .= '$achCMDToEx = ' . $achCMDToEx . ";\n";
    $data .= '$achCMDExPre = ' . $achCMDExPre . ";\n";
    $data .= '$achCMDExN2 = ' . $achCMDExN2 . ";\n";
    $data .= '$autChExPaLex = ' . $autChExPaLex . ";\n";
    $data .= '$autChExCLExPr = ' . $autChExCLExPr . ";\n";
    $data .= '$autChExToEx = ' . $autChExToEx . ";\n";
    $data .= '$autChExExPre = ' . $autChExExPre . ";\n";
    $data .= '$autChExExN2 = ' . $autChExExN2 . ";\n";
    $data .= '$imetPaLex = ' . $imetPaLex . ";\n";
    $data .= '$imetCLExPr = ' . $imetCLExPr . ";\n";
    $data .= '$imetToEx = ' . $imetToEx . ";\n";
    $data .= '$imetExPre = ' . $imetExPre . ";\n";
    $data .= '$imetExN2 = ' . $imetExN2 . ";\n";
    $data .= '$chPrPaLex = ' . $chPrPaLex . ";\n";
    $data .= '$chPrCLExPr = ' . $chPrCLExPr . ";\n";
    $data .= '$chPrToEx = ' . $chPrToEx . ";\n";
    $data .= '$chPrExPre = ' . $chPrExPre . ";\n";
    $data .= '$chPrExN2 = ' . $chPrExN2 . ";\n"; 
    $data .= '$auChExPaLex = ' . $auChExPaLex . ";\n";
    $data .= '$auChExCLExPr = ' . $auChExCLExPr . ";\n";
    $data .= '$auChExExPre = ' . $auChExExPre . ";\n";
    $data .= '$auChExToEx = ' . $auChExToEx . ";\n";
    $data .= '$auChExExN2 = ' . $auChExExN2 . ";\n";
    $data .= '$dExPaLex = ' . $dExPaLex . ";\n";
    $data .= '$dExCLExPr = ' . $dExCLExPr . ";\n";
    $data .= '$dExToEx = ' . $dExToEx . ";\n";
    $data .= '$dExExPre = ' . $dExExPre . ";\n";
    $data .= '$dExExN2 = ' . $dExExN2 . ";\n"; 
    $data .= '$totalIIPaLex = ' . $totalIIPaLex . ";\n";
    $data .= '$totalIICLExPr = ' . $totalIICLExPr . ";\n";
    $data .= '$totalIIToEx = ' . $totalIIToEx . ";\n";
    $data .= '$totalIIExPre = ' . $totalIIExPre . ";\n";
    $data .= '$totalIIExN2 = ' . $totalIIExN2 . ";\n";
    $data .= '$reExI_IIToEx = ' . $reExI_IIToEx . ";\n";
    $data .= '$reExI_IIExPre = ' . $reExI_IIExPre . ";\n";
    $data .= '$reExI_IIExN2 = ' . $reExI_IIExN2 . ";\n";
    $data .= '$prTPPaLex = ' . $prTPPaLex . ";\n";
    $data .= '$prTPCLExPr = ' . $prTPCLExPr . ";\n";
    $data .= '$prTPToEx = ' . $prTPToEx . ";\n";
    $data .= '$prTPExN2 = ' . $prTPExN2 . ";\n";
    $data .= '$prTPExPre = ' . $prTPExPre . ";\n";
    $data .= '$gaChPaLex = ' . $gaChPaLex . ";\n";
    $data .= '$gaChCLExPr = ' . $gaChCLExPr . ";\n";
    $data .= '$gaChToEx = ' . $gaChToEx . ";\n";
    $data .= '$gaChExPre = ' . $gaChExPre . ";\n";
    $data .= '$gaChExN2 = ' . $gaChExN2 . ";\n";
    $data .= '$inAPFPaLex = ' . $inAPFPaLex . ";\n";
    $data .= '$inAPFCLExPr = ' . $inAPFCLExPr . ";\n";
    $data .= '$inAPFToEx = ' . $inAPFToEx . ";\n";
    $data .= '$inAPFExPre = ' . $inAPFExPre . ";\n";
    $data .= '$inAPFExN2 = ' . $inAPFExN2 . ";\n";
    $data .= '$reFTChPaLex = ' . $reFTChPaLex . ";\n";
    $data .= '$reFTChCLExPr = ' . $reFTChCLExPr . ";\n";
    $data .= '$reFTChToEx = ' . $reFTChToEx . ";\n";
    $data .= '$reFTChExPre = ' . $reFTChExPre . ";\n";
    $data .= '$reFTChExN2 = ' . $reFTChExN2 . ";\n";
    $data .= '$totalIVPaLex = ' . $totalIVPaLex . ";\n";
    $data .= '$totalIVCLExPr = ' . $totalIVCLExPr . ";\n";
    $data .= '$totalIVToEx = ' . $totalIVToEx . ";\n";
    $data .= '$totalIVExPre = ' . $totalIVExPre . ";\n";
    $data .= '$totalIVExN2 = ' . $totalIVExN2 . ";\n";
    $data .= '$chiPaLex = ' . $chiPaLex . ";\n";
    $data .= '$chiCLExPr = ' . $chiCLExPr . ";\n";
    $data .= '$chiToEx = ' . $chiToEx . ";\n";
    $data .= '$chiExPre = ' . $chiExPre . ";\n";
    $data .= '$chiExN2 = ' . $chiExN2 . ";\n";
    $data .= '$peChPaLex = ' . $peChPaLex . ";\n";
    $data .= '$peChCLExPr = ' . $peChCLExPr . ";\n";
    $data .= '$peChToEx = ' . $peChToEx . ";\n";
    $data .= '$peChExPre = ' . $peChExPre . ";\n";
    $data .= '$peChExN2 = ' . $peChExN2 . ";\n";
    $data .= '$auChFPaLex = ' . $auChFPaLex . ";\n";
    $data .= '$auChFCLExPr = ' . $auChFCLExPr . ";\n";
    $data .= '$auChFToEx = ' . $auChFToEx . ";\n";
    $data .= '$auChFExPre = ' . $auChFExPre . ";\n";
    $data .= '$auChFExN2 = ' . $auChFExN2 . ";\n";
    $data .= '$doFPaLex = ' . $doFPaLex . ";\n";
    $data .= '$doFCLExPr = ' . $doFCLExPr . ";\n";
    $data .= '$doFToEx = ' . $doFToEx . ";\n";
    $data .= '$doFExPre = ' . $doFExPre . ";\n";
    $data .= '$doFExN2 = ' . $doFExN2 . ";\n";
    $data .= '$totalVPaLex = ' . $totalVPaLex . ";\n";
    $data .= '$totalVCLExPr = ' . $totalVCLExPr . ";\n";
    $data .= '$totalVToEx = ' . $totalVToEx . ";\n";
    $data .= '$totalVExPre = ' . $totalVExPre . ";\n";
    $data .= '$totalVExN2 = ' . $totalVExN2 . ";\n";
    $data .= '$reFToEx = ' . $reFToEx . ";\n";
    $data .= '$reFExPre = ' . $reFExPre . ";\n";
    $data .= '$reFExN2 = ' . $reFExN2 . ";\n";
    $data .= '$reCoToEx = ' . $reCoToEx . ";\n";
    $data .= '$reCoExPre = ' . $reCoExPre . ";\n";
    $data .= '$reCoExN2 = ' . $reCoExN2 . ";\n";
    $data .= '$reTCToEx = ' . $reTCToEx . ";\n";
    $data .= '$reTCExPre = ' . $reTCExPre . ";\n";
    $data .= '$reTCExN2 = ' . $reTCExN2 . ";\n";
    $data .= '$proDCIPaLex = ' . $proDCIPaLex . ";\n";
    $data .= '$proDCICLExPr = ' . $proDCICLExPr . ";\n";
    $data .= '$proDCIToEx = ' . $proDCIToEx . ";\n";
    $data .= '$proDCIExPre = ' . $proDCIExPre . ";\n";
    $data .= '$proDCIExN2 = ' . $proDCIExN2 . ";\n";
    $data .= '$subDEPaLex = ' . $subDEPaLex . ";\n";
    $data .= '$subDECLExPr = ' . $subDECLExPr . ";\n";
    $data .= '$subDEToEx = ' . $subDEToEx . ";\n";
    $data .= '$subDEExPre = ' . $subDEExPre . ";\n";
    $data .= '$subDEExN2 = ' . $subDEExN2 . ";\n";
    $data .= '$reSDPaLex = ' . $reSDPaLex . ";\n";
    $data .= '$reSDCLExPr = ' . $reSDCLExPr . ";\n";
    $data .= '$reSDToEx = ' . $reSDToEx . ";\n";
    $data .= '$reSDExPre = ' . $reSDExPre . ";\n";
    $data .= '$reSDExN2 = ' . $reSDExN2 . ";\n";
    $data .= '$auPrCPaLex = ' . $auPrCPaLex . ";\n";
    $data .= '$auPrCCLExPr = ' . $auPrCCLExPr . ";\n";
    $data .= '$auPrCToEx = ' . $auPrCToEx . ";\n";
    $data .= '$auPrCExPre = ' . $auPrCExPre . ";\n";
    $data .= '$auPrCExN2 = ' . $auPrCExN2 . ";\n";
    $data .= '$reCTCPaLex = ' . $reCTCPaLex . ";\n";
    $data .= '$reCTCCLExPr = ' . $reCTCCLExPr . ";\n";
    $data .= '$reCTCToEx = ' . $reCTCToEx . ";\n";
    $data .= '$reCTCExPre = ' . $reCTCExPre . ";\n";
    $data .= '$reCTCExN2 = ' . $reCTCExN2 . ";\n";
    $data .= '$totalVIIIPaLex = ' . $totalVIIIPaLex . ";\n";
    $data .= '$totalVIIICLExPr = ' . $totalVIIICLExPr . ";\n";
    $data .= '$totalVIIIToEx = ' . $totalVIIIToEx . ";\n";
    $data .= '$totalVIIIExPre = ' . $totalVIIIExPre . ";\n";
    $data .= '$totalVIIIExN2 = ' . $totalVIIIExN2 . ";\n";
    $data .= '$vaNAICPaLex = ' . $vaNAICPaLex . ";\n";
    $data .= '$vaNAICCLExPr = ' . $vaNAICCLExPr . ";\n";
    $data .= '$vaNAICToEx = ' . $vaNAICToEx . ";\n";
    $data .= '$vaNAICExPre = ' . $vaNAICExPre . ";\n";
    $data .= '$vaNAICExN2 = ' . $vaNAICExN2 . ";\n";
    $data .= '$suAcPaLex = ' . $suAcPaLex . ";\n";
    $data .= '$suAcCLExPr = ' . $suAcCLExPr . ";\n";
    $data .= '$suAcToEx = ' . $suAcToEx . ";\n";
    $data .= '$suAcExPre = ' . $suAcExPre . ";\n";
    $data .= '$suAcExN2 = ' . $suAcExN2 . ";\n";
    $data .= '$auCNCPaLex = ' . $auCNCPaLex . ";\n";
    $data .= '$auCNCCLExPr = ' . $auCNCCLExPr . ";\n";
    $data .= '$auCNCToEx = ' . $auCNCToEx . ";\n";
    $data .= '$auCNCExPre = ' . $auCNCExPre . ";\n";
    $data .= '$auCNCExN2 = ' . $auCNCExN2 . ";\n";
    $data .= '$daCAPPaLex = ' . $daCAPPaLex . ";\n";
    $data .= '$daCAPCLExPr = ' . $daCAPCLExPr . ";\n";
    $data .= '$daCAPToEx = ' . $daCAPToEx . ";\n";
    $data .= '$daCAPExPre = ' . $daCAPExPre . ";\n";
    $data .= '$daCAPExN2 = ' . $daCAPExN2 . ";\n";
    $data .= '$totalIXPaLex = ' . $totalIXPaLex . ";\n";
    $data .= '$totalIXCLExPr = ' . $totalIXCLExPr . ";\n";
    $data .= '$totalIXToEx = ' . $totalIXToEx . ";\n";
    $data .= '$totalIXExPre = ' . $totalIXExPre . ";\n";
    $data .= '$totalIXExN2 = ' . $totalIXExN2 . ";\n";
    $data .= '$XReNCToEx = ' . $XReNCToEx . ";\n";
    $data .= '$XReNCExPre = ' . $XReNCExPre . ";\n";
    $data .= '$XReNCExN2 = ' . $XReNCExN2 . ";\n";
    $data .= '$xiResulAIToEx = ' . $xiResulAIToEx . ";\n";
    $data .= '$xiResulAIExPre = ' . $xiResulAIExPre . ";\n";
    $data .= '$xiResulAIExN2 = ' . $xiResulAIExN2 . ";\n";
    $data .= '$xiiIMSLRPaLex = ' . $xiiIMSLRPaLex . ";\n";
    $data .= '$xiiIMSLRCLExPr = ' . $xiiIMSLRCLExPr . ";\n";
    $data .= '$xiiIMSLRToEx = ' . $xiiIMSLRToEx . ";\n";
    $data .= '$xiiIMSLRExPre = ' . $xiiIMSLRExPre . ";\n";
    $data .= '$xiiIMSLRExN2 = ' . $xiiIMSLRExN2 . ";\n";
    $data .= '$xiiReNToEx = ' . $xiiReNToEx . ";\n";
    $data .= '$xiiReNExPre = ' . $xiiReNExPre . ";\n";
    $data .= '$xiiReNExN2 = ' . $xiiReNExN2 . ";\n";
    $data .= '$xivToDPrToEx = ' . $xivToDPrToEx . ";\n";
    $data .= '$xivToDPrExPre = ' . $xivToDPrExPre . ";\n";
    $data .= '$xivToDPrExN2 = ' . $xivToDPrExN2 . ";\n";
    $data .= '$xvToDCHToEx = ' . $xvToDCHToEx . ";\n";
    $data .= '$xvToDCHExPre = ' . $xvToDCHExPre . ";\n";
    $data .= '$xvToDCHExN2 = ' . $xvToDCHExN2 . ";\n";
    $data .= '$xviReNToEx = ' . $xviReNToEx . ";\n";
    $data .= '$xviReNExPre = ' . $xviReNExPre . ";\n";
    $data .= '$xviReNExN2 = ' . $xviReNExN2 . ";\n";
    $data .= "?>";
    // Now, the variable $year will contain the year value "2023"
    $nomFichier = 'Hortaxes_fichier_'. $dateChoisis.'.php';
