...
/**
 * \file    test/phpunit/EtatsComptablesFunctionalTest.php
...
/**
 * Class EtatsComptablesFunctionalTest
 *
 ...
 *
 * @package Testetatscomptables
 */
class EtatsComptablesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEtatsComptables')->click();
		} else {
			// Disable the module
			$this->byHref('modEtatsComptables')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/etatscomptables/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('etatscomptables/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/etatscomptables/admin/about.php');
		$this->authenticate();
		return $this->assertContains('etatscomptables/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('etatscomptableswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEtatsComptables_EtatsComptablesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEtatsComptables_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
