...
class pdf_EtatAffectation extends ModelePDFUser
{
	/**
	...
	public function write_file($object, $outputlangs = "", $srctemplatepath = "", $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams)
	{
		...
		if (true) {
			...
			if ($object->specimen) {
				...
				$dir = DOL_DATA_ROOT . \'/billanLaisse/EtatAffectation/\';
			
				$year=GETPOST(\'valeurdatechoise\');
			
				$file = $dir . "/EtatAffectation".$year . ".pdf";
				// $file = $dir . "/Passif.pdf";
			...
			//	if (!empty($tplidx)) $pdf->useTemplate($tplidx);
				...
				include DOL_DOCUMENT_ROOT . \'/custom/etatscomptables/EtatAffectation/EtatAffectation_fichier_\'.$year.\'.php\';
			...
			<tbody>
			  ...
			  <tr class="row3">
				<td class="column0 style15 n">\'.$etataffectation1.\'</td>
				<td class="column1 style16 null"></td>
				<td class="column2 style17 s">- Réserve légale</td>
				<td class="column3 style18 f">\'.$etataffectation2.\'</td>
			  ...
			  <tr class="row4">
				...
				<td class="column1 style22 f">\'.$etataffectation3.\'</td>
				<td class="column2 style21 s">- Autres réserves</td>
				<td class="column3 style23 f">\'.$etataffectation4.\'</td>
				<td class="column4 style19 null"></td>
			  ...
			  <tr class="row5">
				...
				<td class="column1 style22 f">\'.$etataffectation5.\'</td>
				<td class="column2 style21 s">- Tantièmes</td>
				<td class="column3 style24 null">\'.$etataffectation6.\'</td>
				<td class="column4 style19 null"></td>
			  ...
			  <tr class="row6">
				...
				<td class="column1 style22 f">\'.$etataffectation7.\'</td>
				<td class="column2 style21 s">- Dividendes</td>
				<td class="column3 style23 f">\'.$etataffectation8.\'</td>
				<td class="column4 style19 null"></td>
			  ...
			  <tr class="row7">
				...
				<td class="column1 style23 null">\'.$etataffectation9.\'</td>
				<td class="column2 style21 s">- Autres affectations</td>
				<td class="column3 style24 null">\'.$etataffectation10.\'</td>
				<td class="column4 style19 null"></td>
			  ...
			  <tr class="row8">
				...
				<td class="column1 style27 null">\'.$etataffectation11.\'</td>
				<td class="column2 style26 s">- Report à nouveau</td>
				<td class="column3 style28 f">\'.$etataffectation12.\'</td>
				<td class="column4 style19 null"></td>
				<td class="column8 style6 null"></td>
			  </tr>
			  <tr class="row9">
				<td class="column0 style29 s">Total A</td>
				<td class="column1 style30 f">\'.$TotalA.\'</td>
				<td class="column2 style29 s">Total B</td>
				<td class="column3 style30 f">\'.$TotalB.\'</td>
