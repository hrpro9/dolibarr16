...
<form method="POST" action="confirmeCreditbail.php">
    <table align="center" border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
          ...
          <tr class="row5">
            <td class="column0 style21 null"><input name="valeur0" type="number" min="0" step="any" style="width: 86.07777679pt;text-align:center;" placeholder="0" required id="valeur0" oninput="sumValues()" value="<?php if(isset($valeur0)){ echo $valeur0;} ?>" /></td>
            <td class="column1 style22 null"><input name="valeur1" type="number" min="0" step="any" style="width: 46.76666613pt;text-align:center;" placeholder="0" required id="valeur1" oninput="sumValues()" value="<?php if(isset($valeur1)){ echo $valeur1;} ?>" /></td>
            ...
            <td class="column10 style23 null"><input name="valeur10" type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required id="valeur10" oninput="sumValues()" value="<?php if(isset($valeur10)){ echo $valeur10;} ?>"/></td>
          </tr>
          <tr class="row6">
            <td class="column0 style21 null"><input type="number" min="0" step="any" style="width: 86.07777679pt;text-align:center;" placeholder="0" required /></td>
            <td class="column1 style22 null"><input type="number" min="0" step="any" style="width: 46.76666613pt;text-align:center;" placeholder="0" required/></td>
            <td class="column2 style21 null"><input type="number" min="0" step="any" style="width: 37.95555512pt;text-align:center;" placeholder="0" required /></td>
            <td class="column3 style23 null"><input type="number" min="0" step="any" style="width: 69.81111031pt;text-align:center;" placeholder="0" required /></td>
            <td class="column4 style21 null"><input type="number" min="0" step="any" style="width: 37.95555512pt;text-align:center;" placeholder="0" required /></td>
            <td class="column5 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column6 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column7 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column8 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column9 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column10 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
          </tr>
          <tr class="row7">
            <td class="column0 style21 null"><input type="number" min="0" step="any" style="width: 86.07777679pt;text-align:center;" placeholder="0" required/></td>
            <td class="column1 style22 null"><input type="number" min="0" step="any" style="width: 46.76666613pt;text-align:center;" placeholder="0" required/></td>
          ...
          <tr class="row13">
            ...
            <td class="column9 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column10 style23 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column11 style24 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
          </tr>
          <tr class="row14">
            <td class="column0 style21 null"><input type="number" min="0" step="any" style="width: 86.07777679pt;text-align:center;" placeholder="0" required/></td>
            <td class="column1 style22 null"><input type="number" min="0" step="any" style="width: 46.76666613pt;text-align:center;" placeholder="0" required/></td>
          ...
          <tr class="row16">
            <td class="column0 style25 null"><input type="number" min="0" step="any" style="width: 86.07777679pt;text-align:center;" placeholder="0" required/></td>
            <td class="column1 style26 null"><input type="number" min="0" step="any" style="width: 46.76666613pt;text-align:center;" placeholder="0" required/></td>
            <td class="column2 style25 null"><input type="number" min="0" step="any" style="width: 37.95555512pt;text-align:center;" placeholder="0" required /></td>
            <td class="column3 style27 null"><input type="number" min="0" step="any" style="width: 69.81111031pt;text-align:center;" placeholder="0" required /></td>
            <td class="column4 style25 null"><input type="number" min="0" step="any" style="width: 37.95555512pt;text-align:center;" placeholder="0" required /></td>
            <td class="column5 style27 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column6 style27 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column7 style27 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column8 style27 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column9 style27 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
            <td class="column10 style27 null"><input type="number" min="0" step="any" style="width: 59.64444376pt;text-align:center;" placeholder="0" required /></td>
    ...
    <script>
    function sumValues() {
        var valeur0 = parseFloat(document.getElementById("valeur0").value) ?? 0;
        var valeur1 = parseFloat(document.getElementById("valeur1").value) ?? 0;
        
        var sum = valeur0 + valeur1 ;
