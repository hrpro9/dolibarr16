...
// {
  ...
  $data = "<?php ";
	...
	$data .= '$achatRevMarch_E = ' . $achatRevMarch_E . ";\n";
	$data .= '$achatRevMarch_EP = ' . $achatRevMarch_EP . ";\n";
	$data .= '$achatRevMarch_E2 = ' . $achatRevMarch_E2 . ";\n";
	$data .= '$achatMarch_E = ' . $achatMarch_E . ";\n";
	$data .= '$achatMarch_EP = ' . $achatMarch_EP . ";\n";
	$data .= '$achatMarch_E2 = ' . $achatMarch_E2 . ";\n";
	$data .= '$varStock_E = ' . $varStock_E . ";\n";
	$data .= '$varStock_EP = ' . $varStock_EP . ";\n";
	$data .= '$varStock_E2 = ' . $varStock_E2 . ";\n";
	$data .= '$total1_E = ' . $total1_E . ";\n";
	$data .= '$total1_EP = ' . $total1_EP . ";\n";
	$data .= '$total1_E2 = ' . $total1_E2 . ";\n";
	$data .= '$achatConsMat_E = ' . $achatConsMat_E . ";\n";
	$data .= '$achatConsMat_EP = ' . $achatConsMat_EP . ";\n";
	$data .= '$achatConsMat_E2 = ' . $achatConsMat_E2 . ";\n";
	$data .= '$achatMatPre_E = ' . $achatMatPre_E . ";\n";
	$data .= '$achatMatPre_EP = ' . $achatMatPre_EP . ";\n";
	$data .= '$achatMatPre_E2 = ' . $achatMatPre_E2 . ";\n";
	$data .= '$varStockMat_E = ' . $varStockMat_E . ";\n";
	$data .= '$varStockMat_EP = ' . $varStockMat_EP . ";\n";
	$data .= '$varStockMat_E2 = ' . $varStockMat_E2 . ";\n";
	$data .= '$achatMatFourn_E = ' . $achatMatFourn_E . ";\n";
	$data .= '$achatMatFourn_EP = ' . $achatMatFourn_EP . ";\n";
	$data .= '$achatMatFourn_E2 = ' . $achatMatFourn_E2 . ";\n";
	$data .= '$varStockMatFourn_E = ' . $varStockMatFourn_E . ";\n";
	$data .= '$varStockMatFourn_E = ' . $varStockMatFourn_E . ";\n";
	$data .= '$varStockMatFourn_E = ' . $varStockMatFourn_E . ";\n";
	$data .= '$achatNonStockMat_E = ' . $achatNonStockMat_E . ";\n";
	$data .= '$achatNonStockMat_EP = ' . $achatNonStockMat_EP . ";\n";
	$data .= '$achatNonStockMat_E2 = ' . $achatNonStockMat_E2 . ";\n";
	$data .= '$achatTravEtud_E = ' . $achatTravEtud_E . ";\n";
	$data .= '$achatTravEtud_EP = ' . $achatTravEtud_EP . ";\n";
	$data .= '$achatTravEtud_E2 = ' . $achatTravEtud_E2 . ";\n";
	$data .= '$total2_E = ' . $total2_E . ";\n";
	$data .= '$total2_EP = ' . $total2_EP . ";\n";
	$data .= '$total2_E2 = ' . $total2_E2 . ";\n";
	$data .= '$autreCharg_E = ' . $autreCharg_E . ";\n";
	$data .= '$autreCharg_EP = ' . $autreCharg_EP . ";\n";
	$data .= '$autreCharg_E2 = ' . $autreCharg_E2 . ";\n";
	$data .= '$locatCharg_E = ' . $locatCharg_E . ";\n";
	$data .= '$locatCharg_EP = ' . $locatCharg_EP . ";\n";
	$data .= '$locatCharg_E2 = ' . $locatCharg_E2 . ";\n";
	$data .= '$redCred_E = ' . $redCred_E . ";\n";
	$data .= '$redCred_EP = ' . $redCred_EP . ";\n";
	$data .= '$redCred2_E2 = ' . $redCred2_E2 . ";\n";
	$data .= '$entreRepa_E = ' . $entreRepa_E . ";\n";
	$data .= '$entreRepa_EP = ' . $entreRepa_EP . ";\n";
	$data .= '$entreRepa_E2 = ' . $entreRepa_E2 . ";\n";
	$data .= '$primeAssur_E = ' . $primeAssur_E . ";\n";
	$data .= '$primeAssur_EP = ' . $primeAssur_EP . ";\n";
	$data .= '$primeAssur_E2 = ' . $primeAssur_E2 . ";\n";
	$data .= '$remunePers_E = ' . $remunePers_E . ";\n";
	$data .= '$remunePers_EP = ' . $remunePers_EP . ";\n";
	$data .= '$remunePers_E2 = ' . $remunePers_E2 . ";\n";
	$data .= '$remuneInter_E = ' . $remuneInter_E . ";\n";
	$data .= '$remunePers_EP = ' . $remuneInter_EP . ";\n";
	$data .= '$remuneInter_EP = ' . $remuneInter_EP . ";\n";
	$data .= '$redevBrevet_E = ' . $redevBrevet_E . ";\n";
	$data .= '$redevBrevet_EP = ' . $redevBrevet_EP . ";\n";
	$data .= '$redevBrevet2_E2 = ' . $redevBrevet2_E2 . ";\n";
	$data .= '$trans_E = ' . $trans_E . ";\n";
	$data .= '$trans_EP = ' . $trans_EP . ";\n";
	$data .= '$trans_E2 = ' . $trans_E2 . ";\n";
	$data .= '$deplacMiss_E = ' . $deplacMiss_E . ";\n";
	$data .= '$deplacMiss_EP = ' . $deplacMiss_EP . ";\n";
	$data .= '$deplacMiss_E2 = ' . $deplacMiss_E2 . ";\n";
	$data .= '$restPoste_E = ' . $restPoste_E . ";\n";
	$data .= '$restPoste_EP = ' . $restPoste_EP . ";\n";
	$data .= '$restPoste_E2 = ' . $restPoste_E2 . ";\n";
	$data .= '$total3_E = ' . $total3_E . ";\n";
	$data .= '$total3_EP = ' . $total3_EP . ";\n";
	$data .= '$total3_E2 = ' . $total3_E2 . ";\n";
	$data .= '$chagePers_E = ' . $chagePers_E . ";\n";
	$data .= '$chagePers_EP = ' . $chagePers_EP . ";\n";
	$data .= '$chagePers_E2 = ' . $chagePers_E2 . ";\n";
	$data .= '$remunePerso_E = ' . $remunePerso_E . ";\n";
	$data .= '$remunePerso_EP = ' . $remunePerso_EP . ";\n";
	$data .= '$remunePerso_E2 = ' . $remunePerso_E2 . ";\n";
	$data .= '$chageSocial_E = ' . $chageSocial_E . ";\n";
	$data .= '$chageSocial_EP = ' . $chageSocial_EP . ";\n";
	$data .= '$chageSocial_E2 = ' . $chageSocial_E2 . ";\n";
	$data .= '$restPosteCharg_E = ' . $restPosteCharg_E . ";\n";
	$data .= '$restPosteCharg_EP = ' . $restPosteCharg_EP . ";\n";
	$data .= '$restPosteCharg_E2 = ' . $restPosteCharg_E2 . ";\n";
	$data .= '$total4_E = ' . $total4_E . ";\n";
	$data .= '$total4_EP = ' . $total4_EP . ";\n";
	$data .= '$total4_E2 = ' . $total4_E2 . ";\n";
	$data .= '$autreChargeExp_E = ' . $autreChargeExp_E . ";\n";
	$data .= '$autreChargeExp_EP = ' . $autreChargeExp_EP . ";\n";
	$data .= '$autreChargeExp_E2 = ' . $autreChargeExp_E2 . ";\n";
	$data .= '$jetonPres_E = ' . $jetonPres_E . ";\n";
	$data .= '$jetonPres_EP = ' . $jetonPres_EP . ";\n";
	$data .= '$jetonPres_E2 = ' . $jetonPres_E2 . ";\n";
	$data .= '$perteCre_E = ' . $perteCre_E . ";\n";
	$data .= '$perteCre_EP = ' . $perteCre_EP . ";\n";
	$data .= '$perteCre_E2 = ' . $perteCre_E2 . ";\n";
	$data .= '$restPosteChargExp_E = ' . $restPosteChargExp_E . ";\n";
	$data .= '$restPosteChargExp_EP = ' . $restPosteChargExp_EP . ";\n";
	$data .= '$restPosteChargExp_E2 = ' . $restPosteChargExp_E2 . ";\n";
	$data .= '$total5_E = ' . $total5_E . ";\n";
	$data .= '$total5_EP = ' . $total5_EP . ";\n";
	$data .= '$total5_E2 = ' . $total5_E2 . ";\n";
	$data .= '$total5_E = ' . $total5_E . ";\n";
	$data .= '$total5_EP = ' . $total5_EP . ";\n";
	$data .= '$total5_E2 = ' . $total5_E2 . ";\n";
	$data .= '$autreChargFin_E = ' . $autreChargFin_E . ";\n";
	$data .= '$autreChargFin_EP = ' . $autreChargFin_EP . ";\n";
	$data .= '$autreChargFin_E2 = ' . $autreChargFin_E2 . ";\n";
	$data .= '$chargeNet_E = ' . $chargeNet_E . ";\n";
	$data .= '$chargeNet_EP = ' . $chargeNet_EP . ";\n";
	$data .= '$chargeNet_E2 = ' . $chargeNet_E2 . ";\n";
	$data .= '$restPosteFin_E = ' . $restPosteFin_E . ";\n";
	$data .= '$restPosteFin_EP = ' . $restPosteFin_EP . ";\n";
	$data .= '$restPosteFin_E2 = ' . $restPosteFin_E2 . ";\n";
	$data .= '$tatal6_E = ' . $tatal6_E . ";\n";
	$data .= '$tatal6_EP = ' . $tatal6_EP . ";\n";
	$data .= '$tatal6_E2 = ' . $tatal6_E2 . ";\n";
	$data .= '$tatal6_E = ' . $tatal6_E . ";\n";
	$data .= '$tatal6_EP = ' . $tatal6_EP . ";\n";
	$data .= '$tatal6_E2 = ' . $tatal6_E2 . ";\n";
	$data .= '$autreChargN_E = ' . $autreChargN_E . ";\n";
	$data .= '$autreChargN_EP = ' . $autreChargN_EP . ";\n";
	$data .= '$autreChargN_E2 = ' . $autreChargN_E2 . ";\n";
	$data .= '$penalMarch_E = ' . $penalMarch_E . ";\n";
	$data .= '$penalMarch_EP = ' . $penalMarch_EP . ";\n";
	$data .= '$penalMarch_E2 = ' . $penalMarch_E2 . ";\n";
	$data .= '$rappelImpo_E = ' . $rappelImpo_E . ";\n";
	$data .= '$rappelImpo_EP = ' . $rappelImpo_EP . ";\n";
	$data .= '$rappelImpo_E2 = ' . $rappelImpo_E2 . ";\n";
	$data .= '$penalAmand_E = ' . $penalAmand_E . ";\n";
	$data .= '$penalAmand_EP = ' . $penalAmand_EP . ";\n";
	$data .= '$penalAmand_E2 = ' . $penalAmand_E2 . ";\n";
	$data .= '$creanDeven_E = ' . $creanDeven_E . ";\n";
	$data .= '$creanDeven_EP = ' . $creanDeven_EP . ";\n";
	$data .= '$creanDeven_E2 = ' . $creanDeven_E2 . ";\n";
	$data .= '$restePosteNonC_E = ' . $restePosteNonC_E . ";\n";
	$data .= '$restePosteNonC_EP = ' . $restePosteNonC_EP . ";\n";
	$data .= '$restePosteNonC_E2 = ' . $restePosteNonC_E2 . ";\n";
	$data .= '$total7_E = ' . $total7_E . ";\n";
	$data .= '$total7_EP = ' . $total7_EP . ";\n";
	$data .= '$total7_E2 = ' . $total7_E2 . ";\n";
	$data .= '$total7_E = ' . $total7_E . ";\n";
	$data .= '$total7_EP = ' . $total7_EP . ";\n";
	$data .= '$total7_E2 = ' . $total7_E2 . ";\n";
	...
	$data .= '$venteMarch_E = ' . $venteMarch_E . ";\n";
	$data .= '$venteMarch_E = ' . $venteMarch_E . ";\n";
	$data .= '$venteMarch_E = ' .-($venteMarchMar_E) . ";\n";
	$data .= '$venteMarchMar_E = ' . -($venteMarchMar_E) . ";\n";
	$data .= '$venteMarchMar_E = ' .-($venteMarchMar_E) . ";\n";
	$data .= '$venteMarchEtrg_E = ' .$venteMarchEtrg_E. ";\n";
	$data .= '$venteMarchEtrg_E = ' . $venteMarchEtrg_E . ";\n";
	$data .= '$venteMarchEtrg_E = ' .$venteMarchEtrg_E. ";\n";
	$data .= '$restePosteMarch_E = ' . $restePosteMarch_E. ";\n";
	$data .= '$restePosteMarch_E = ' . $restePosteMarch_E . ";\n";
	$data .= '$restePosteMarch_E = ' .$restePosteMarch_E . ";\n";
	$data .= '$total8_E = ' .$total8_E . ";\n";
	$data .= '$total8_E = ' . $total8_E . ";\n";
	$data .= '$total8_E = ' .$total8_E . ";\n";
	$data .= '$venteBienServ_E = ' .-($venteBienServ_E) . ";\n";
	$data .= '$venteBienServ_E = ' . -($venteBienServ_E) . ";\n";
	$data .= '$venteBienServ_E = ' .-($venteBienServ_E) . ";\n";
	$data .= '$venteBienMar_E = ' .$venteBienMar_E. ";\n";
	$data .= '$venteBienMar_E = ' . $venteBienMar_E . ";\n";
	$data .= '$venteBienMar_E = ' .$venteBienMar_E. ";\n";
	$data .= '$venteBienEtrg_E = ' .$venteBienEtrg_E . ";\n";
	$data .= '$venteBienEtrg_EP = ' . $venteBienEtrg_EP. ";\n";
	$data .= '$venteBienEtrg_E2 = ' .$venteBienEtrg_E2. ";\n";
	$data .= '$venteServMar_E = ' .$venteServMar_E . ";\n";
	$data .= '$venteServMar_E = ' . $venteServMar_E. ";\n";
	$data .= '$venteServMar_E = ' .$venteServMar_E. ";\n";
	$data .= '$venteServEtrg_E = ' .$venteServEtrg_E . ";\n";
	$data .= '$venteServEtrg_EP = ' . $venteServEtrg_EP. ";\n";
	$data .= '$venteServEtrg_E2 = ' .$venteServEtrg_E2. ";\n";
	$data .= '$redevBrevet_E = ' .$redevBrevet_E . ";\n";
	$data .= '$redevBrevet_EP = ' . $redevBrevet_EP. ";\n";
	$data .= '$redevBrevet_E2 = ' .$redevBrevet_E2. ";\n";
	$data .= '$restPosteVente_E = ' .$restPosteVente_E . ";\n";
	$data .= '$restPosteVente_EP = ' . $restPosteVente_EP. ";\n";
	$data .= '$restPosteVente_E2 = ' .$restPosteVente_E2. ";\n";
	$data .= '$total9_E = ' .$total9_E . ";\n";
	$data .= '$total9_EP = ' . $total9_EP. ";\n";
	$data .= '$total9_E2 = ' .$total9_E2. ";\n";
	$data .= '$varStockProd_E = ' .(-($varStockProd_E)) . ";\n";
	$data .= '$varStockProd_EP = ' . (-($varStockProd_EP)). ";\n";
	$data .= '$varStockProd_E2 = ' .(-($varStockProd_E2)). ";\n";
	$data .= '$varStockProdC_E = ' .$varStockProdC_E . ";\n";
	$data .= '$varStockProdC_E = ' . $varStockProdC_E. ";\n";
	$data .= '$varStockProdC_E = ' .$varStockProdC_E. ";\n";
	$data .= '$varStockBien_E = ' .$varStockBien_E . ";\n";
	$data .= '$varStockBien_E = ' . $varStockBien_E. ";\n";
	$data .= '$varStockBien_E = ' .$varStockBien_E. ";\n";
	$data .= '$varStockServ_E = ' .$varStockServ_E . ";\n";
	$data .= '$varStockServ_E = ' . $varStockServ_E. ";\n";
	$data .= '$varStockServ_E = ' .$varStockServ_E. ";\n";	
	$data .= '$total10_E = ' .$total10_E . ";\n";
	$data .= '$total10_E = ' . $total10_E. ";\n";
	$data .= '$total10_E = ' .$total10_E. ";\n";
	$data .= '$autreProd_E = ' .(-($autreProd_E)) . ";\n";
	$data .= '$autreProd_EP = ' .(-($autreProd_EP)). ";\n";
	$data .= '$autreProd_E2 = ' .(-($autreProd_E2)). ";\n";
	$data .= '$jetoPre_E = ' .(-($jetoPre_E)) . ";\n";
	...
	$data .= '$repriseExpl_E = ' .(-($repriseExpl_E)). ";\n";
	$data .= '$repriseExpl_EP = ' .(-($repriseExpl_EP)). ";\n";
	$data .= '$repriseExpl_E2 = ' .(-($repriseExpl_E2)). ";\n";
	$data .= '$reprise_E = ' .$reprise_E. ";\n";
	$data .= '$reprise_EP = ' .$reprise_EP. ";\n";
	$data .= '$reprise_E2 = ' .$reprise_E2. ";\n";	
	$data .= '$transCharg_E = ' .$transCharg_E. ";\n";
	$data .= '$transCharg_EP = ' .$transCharg_EP. ";\n";
	$data .= '$transCharg_E2 = ' .$transCharg_E2. ";\n";
	$data .= '$total12_E = ' .$total12_E. ";\n";
	$data .= '$total12_EP = ' .$total12_EP. ";\n";
	$data .= '$total12_E2 = ' .$total12_E2. ";\n";	
	$data .= '$interetAutre_E = ' .$interetAutre_E. ";\n";
	$data .= '$interetAutre_EP = ' .$interetAutre_EP. ";\n";
	$data .= '$interetAutre_E2 = ' .$interetAutre_E2. ";\n";
	$data .= '$interetProd_E = ' .$interetProd_E. ";\n";
	$data .= '$interetProd_EP = ' .$interetProd_EP. ";\n";
	$data .= '$interetProd_E2 = ' .$interetProd_E2. ";\n";
	$data .= '$revenuCrean_E = ' .$revenuCrean_E. ";\n";
	$data .= '$revenuCrean_EP = ' .$revenuCrean_EP. ";\n";
	$data .= '$revenuCrean_E2 = ' .$revenuCrean_E2. ";\n";
	$data .= '$produitNet_E = ' .$produitNet_E. ";\n";
	$data .= '$produitNet_EP = ' .$produitNet_EP. ";\n";
	$data .= '$produitNet_E2 = ' .$produitNet_E2. ";\n";
	$data .= '$restePosteIntert_E = ' .$restePosteIntert_E. ";\n";
	$data .= '$restePosteIntert_EP = ' .$restePosteIntert_EP. ";\n";
	$data .= '$restePosteIntert_E2 = ' .$restePosteIntert_E2. ";\n";
	$data .= '$total13_E = ' .$total13_E. ";\n";
	$data .= '$total13_EP = ' .$total13_EP. ";\n";
	$data .= '$total13_E2 = ' .$total13_E2. ";\n";


  $data .= "?>";
 // Now, the variable $year will contain the year value "2023"
 $nomFichier = 'Cpc_fichier_'. $dateChoisis.'.php';
