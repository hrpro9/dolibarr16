...
//   $dateChoisis=2022;
  ...
  {
    $data = "<?php ";
    $data .= '$capitauxPropres = ' . ($capitauxPropres*-1*-1) . ";\n";
    $data .= '$capitauxPropresN1 = ' . ($capitauxPropresN1*-1*-1) . ";\n";
    $data .= '$capitauxPropresN2 = ' . ($capitauxPropresN2*-1*-1) . ";\n";
    $data .= '$CapitalSocialPersonnel = ' . ($CapitalSocialPersonnel*-1*-1) . ";\n";
    $data .= '$CapitalSocialPersonnelN1 = ' . ($CapitalSocialPersonnelN1*-1*-1) . ";\n";
    $data .= '$CapitalSocialPersonnelN2 = ' . ($CapitalSocialPersonnelN2*-1*-1) . ";\n";
    $data .= '$aCapita = ' . ($aCapita*-1*-1) . ";\n";
    $data .= '$aCapitaN1 = ' . ($aCapitaN1*-1*-1) . ";\n";
    $data .= '$aCapitaN2 = ' . ($aCapitaN2*-1*-1) . ";\n";
    $data .= '$PrimeDFD = ' . ($PrimeDFD*-1*-1) . ";\n";
    $data .= '$PrimeDFDN1 = ' . ($PrimeDFDN1*-1*-1) . ";\n";
    $data .= '$PrimeDFDN2 = ' . ($PrimeDFDN2*-1*-1) . ";\n";
    $data .= '$EcartsR = ' . ($EcartsR*-1*-1) . ";\n";
    $data .= '$EcartsRN1 = ' . ($EcartsRN1*-1*-1) . ";\n";
    $data .= '$EcartsRN2 = ' . ($EcartsRN2*-1*-1) . ";\n";
    $data .= '$reserveL = ' . ($reserveL*-1*-1) . ";\n";
    $data .= '$reserveLN1 = ' . ($reserveLN1*-1*-1) . ";\n";
    $data .= '$reserveLN2 = ' . ($reserveLN2*-1*-1) . ";\n";
    $data .= '$autresR = ' . ($autresR*-1*-1) . ";\n";
    $data .= '$autresRN1 = ' . ($autresRN1*-1*-1) . ";\n";
    $data .= '$autresRN2 = ' . ($autresRN2*-1*-1) . ";\n";
    $data .= '$ReportN = ' . ($ReportN*-1*-1) . ";\n";
    $data .= '$ReportNN1 = ' . ($ReportNN1*-1*-1) . ";\n";
    $data .= '$ReportNN2 = ' . ($ReportNN2*-1*-1) . ";\n";
    $data .= '$resultatNID = ' . ($resultatNID*-1*-1) . ";\n";
    $data .= '$resultatNIDN1 = ' . ($resultatNIDN1*-1*-1) . ";\n";
    $data .= '$resultatNIDN2 = ' . ($resultatNIDN2*-1*-1) . ";\n";
    $data .= '$resultatNL = ' . ($resultatNL*-1*-1) . ";\n";
    $data .= '$resultatNLN1 = ' . ($resultatNLN1*-1*-1) . ";\n";
    $data .= '$resultatNLN2 = ' . ($resultatNLN2*-1*-1) . ";\n";
    $data .= '$totalCP = ' . ($totalCP*-1*-1) . ";\n";
    $data .= '$totalCPN1 = ' . ($totalCPN1*-1*-1) . ";\n";
    $data .= '$totalCPN2 = ' . ($totalCPN2*-1*-1) . ";\n";
    $data .= '$capitauxPA = ' . ($capitauxPA*-1*-1) . ";\n";
    $data .= '$capitauxPAN1 = ' . ($capitauxPAN1*-1*-1) . ";\n";
    $data .= '$capitauxPAN2 = ' . ($capitauxPAN2*-1*-1) . ";\n";
    $data .= '$SubventionsD = ' . ($SubventionsD*-1*-1) . ";\n";
    $data .= '$SubventionsDN1 = ' . ($SubventionsDN1*-1*-1) . ";\n";
    $data .= '$SubventionsDN2 = ' . ($SubventionsDN2*-1*-1) . ";\n";
    $data .= '$provisionsR = ' . ($provisionsR*-1*-1) . ";\n";
    $data .= '$provisionsRN1 = ' . ($provisionsRN1*-1*-1) . ";\n";
    $data .= '$provisionsRN2 = ' . ($provisionsRN2*-1*-1) . ";\n";
    $data .= '$dettesDF = ' . ($dettesDF*-1*-1) . ";\n";
    $data .= '$dettesDFN1 = ' . ($dettesDFN1*-1*-1) . ";\n";
    $data .= '$dettesDFN2 = ' . ($dettesDFN2*-1*-1) . ";\n";
    $data .= '$empruntsO = ' . ($empruntsO*-1*-1) . ";\n";
    $data .= '$empruntsON1 = ' . ($empruntsON1*-1*-1) . ";\n";
    $data .= '$empruntsON2 = ' . ($empruntsON2*-1*-1) . ";\n";
    $data .= '$autresDF = ' . ($autresDF*-1*-1) . ";\n";
    $data .= '$autresDFN1 = ' . ($autresDFN1*-1*-1) . ";\n";
    $data .= '$autresDFN2 = ' . ($autresDFN2*-1*-1) . ";\n";
    $data .= '$provisionsDPREC = ' . ($provisionsDPREC*-1*-1) . ";\n";
    $data .= '$provisionsDPRECN1 = ' . ($provisionsDPRECN1*-1*-1) . ";\n";
    $data .= '$provisionsDPRECN2 = ' . ($provisionsDPRECN2*-1*-1) . ";\n";
    $data .= '$provisionsPR = ' . ($provisionsPR*-1*-1) . ";\n";
    $data .= '$provisionsPRN1 = ' . ($provisionsPRN1*-1*-1) . ";\n";
    $data .= '$provisionsPRN2 = ' . ($provisionsPRN2*-1*-1) . ";\n";
    $data .= '$provisionsPC = ' . ($provisionsPC*-1*-1) . ";\n";
    $data .= '$provisionsPCN1 = ' . ($provisionsPCN1*-1*-1) . ";\n";
    $data .= '$provisionsPCN2 = ' . ($provisionsPCN2*-1*-1) . ";\n";
    $data .= '$ecartsDCP = ' . ($ecartsDCP*-1*-1) . ";\n";
    $data .= '$ecartsDCPN1 = ' . ($ecartsDCPN1*-1*-1) . ";\n";
    $data .= '$ecartsDCPN2 = ' . ($ecartsDCPN2*-1*-1) . ";\n";
    $data .= '$augmentationDCI = ' . ($augmentationDCI*-1*-1) . ";\n";
    $data .= '$augmentationDCIN1 = ' . ($augmentationDCIN1*-1*-1) . ";\n";
    $data .= '$augmentationDCIN2 = ' . ($augmentationDCIN2*-1*-1) . ";\n";
    $data .= '$diminutionDF = ' . ($diminutionDF*-1*-1) . ";\n";
    $data .= '$diminutionDFN1 = ' . ($diminutionDFN1*-1*-1) . ";\n";
    $data .= '$diminutionDFN2 = ' . ($diminutionDFN2*-1*-1) . ";\n";
    $data .= '$totalABCDE = ' . ($totalABCDE*-1*-1) . ";\n";
    $data .= '$totalABCDEN1 = ' . ($totalABCDEN1*-1*-1) . ";\n";
    $data .= '$totalABCDEN2 = ' . ($totalABCDEN2*-1*-1) . ";\n";
    $data .= '$dettesDPC = ' . ($dettesDPC*-1*-1) . ";\n";
    $data .= '$dettesDPCN1 = ' . ($dettesDPCN1*-1*-1) . ";\n";
    $data .= '$dettesDPCN2 = ' . ($dettesDPCN2*-1*-1) . ";\n";
    $data .= '$fournisseursECR = ' . ($fournisseursECR*-1*-1) . ";\n";
    $data .= '$fournisseursECRN1 = ' . ($fournisseursECRN1*-1*-1) . ";\n";
    $data .= '$fournisseursECRN2 = ' . ($fournisseursECRN2*-1*-1) . ";\n";
    $data .= '$ClientsCAVA = ' . ($ClientsCAVA*-1*-1) . ";\n";
    $data .= '$ClientsCAVAN1 = ' . ($ClientsCAVAN1*-1*-1) . ";\n";
    $data .= '$ClientsCAVAN2 = ' . ($ClientsCAVAN2*-1*-1) . ";\n";
    $data .= '$personnel = ' . ($personnel*-1*-1) . ";\n";
    $data .= '$personnelN1 = ' . ($personnelN1*-1*-1) . ";\n";
    $data .= '$personnelN2 = ' . ($personnelN2*-1*-1) . ";\n";
    $data .= '$organismesS = ' . ($organismesS*-1*-1) . ";\n";
    $data .= '$organismesSN1 = ' . ($organismesSN1*-1*-1) . ";\n";
    $data .= '$organismesSN2 = ' . ($organismesSN2*-1*-1) . ";\n";
    $data .= '$etat = ' . ($etat*-1*-1) . ";\n";
    $data .= '$etatN1 = ' . ($etatN1*-1*-1) . ";\n";
    $data .= '$etatN2 = ' . ($etatN2*-1*-1) . ";\n";
    $data .= '$comptesD = ' . ($comptesD*-1*-1) . ";\n";
    $data .= '$comptesDN1 = ' . ($comptesDN1*-1*-1) . ";\n";
    $data .= '$comptesDN2 = ' . ($etatN2*-1*-1) . ";\n";
    $data .= '$autresCr = ' . ($autresCr*-1*-1) . ";\n";
    $data .= '$autresCrN1 = ' . ($autresCrN1*-1*-1) . ";\n";
    $data .= '$autresCrN2 = ' . ($autresCrN2*-1*-1) . ";\n";
    $data .= '$comptesDRP = ' . ($comptesDRP*-1*-1) . ";\n";
    $data .= '$comptesDRPN1 = ' . ($comptesDRPN1*-1*-1) . ";\n";
    $data .= '$comptesDRPN2 = ' . ($comptesDRPN2*-1*-1) . ";\n";
    $data .= '$autresPPREC = ' . ($autresPPREC*-1*-1) . ";\n";
    $data .= '$autresPPRECN1 = ' . ($autresPPRECN1*-1*-1) . ";\n";
    $data .= '$autresPPRECN2 = ' . ($autresPPRECN2*-1*-1) . ";\n";
    $data .= '$ecartsDCP = ' . ($ecartsDCP*-1*-1) . ";\n";
    $data .= '$ecartsDCPN1 = ' . ($ecartsDCPN1*-1*-1) . ";\n";
    $data .= '$ecartsDCPN2 = ' . ($ecartsDCPN2*-1*-1) . ";\n";
    $data .= '$totalFGH = ' . ($totalFGH*-1*-1) . ";\n";
    $data .= '$totalFGHN1 = ' . ($totalFGHN1*-1*-1) . ";\n";
    $data .= '$totalFGHN2 = ' . ($totalFGHN2*-1*-1) . ";\n";
    $data .= '$tresorerie = ' . ($tresorerie*-1*-1) . ";\n";
    $data .= '$tresorerieN1 = ' . ($tresorerieN1*-1*-1) . ";\n";
    $data .= '$tresorerieN2 = ' . ($tresorerieN2*-1*-1) . ";\n";
    $data .= '$creditsDE = ' . ($creditsDE*-1*-1) . ";\n";
    $data .= '$creditsDEN1 = ' . ($creditsDEN1*-1*-1) . ";\n";
    $data .= '$creditsDEN2 = ' . ($creditsDEN2*-1*-1) . ";\n";
    $data .= '$creditDT = ' . ($creditDT*-1*-1) . ";\n";
    $data .= '$creditDTN1 = ' . ($creditDTN1*-1*-1) . ";\n";
    $data .= '$creditDTN2 = ' . ($creditDTN2*-1*-1) . ";\n";
    $data .= '$banquesSC = ' . ($banquesSC*-1*-1) . ";\n";
    $data .= '$banquesSCN1 = ' . ($banquesSCN1*-1*-1) . ";\n";
    $data .= '$banquesSCN2 = ' . ($banquesSCN2*-1*-1) . ";\n";
    $data .= '$totalIII = ' . ($totalIII*-1*-1) . ";\n";
    $data .= '$totalIIIN1 = ' . ($totalIIIN1*-1*-1) . ";\n";
    $data .= '$totalIIIN2 = ' . ($totalIIIN2*-1*-1) . ";\n";
    $data .= '$total_I_II_III = ' . ($total_I_II_III*-1*-1) . ";\n";
    $data .= '$total_I_II_IIIN1 = ' . ($total_I_II_IIIN1*-1*-1) . ";\n";
    $data .= '$total_I_II_IIIN2 = ' . ($total_I_II_IIIN2*-1*-1) . ";\n";
    $data .= "?>";
    // Now, the variable $year will contain the year value "2023"
    $nomFichier = 'Passif_fichier_'. $dateChoisis.'.php';
