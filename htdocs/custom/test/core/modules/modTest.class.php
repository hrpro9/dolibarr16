 ...
 * Copyright (C) 2023 Anass EL ASSRI
 *
...
class modTest extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		$this->rights[$r][5] = 'read'; // In php code, permission will be checked by test if ($user->rights->test->myobject->read)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Create/Update objects of Test'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->test->myobject->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Delete objects of Test'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->test->myobject->delete)
		$r++;
		...
		$this->import_convertvalue_array[$r] = array(
			't.ref' => array(
				'rule'=>'getrefifauto',
				'class'=>(empty($conf->global->TEST_MYOBJECT_ADDON) ? 'mod_myobject_standard' : $conf->global->TEST_MYOBJECT_ADDON),
				'path'=>"/core/modules/commande/".(empty($conf->global->TEST_MYOBJECT_ADDON) ? 'mod_myobject_standard' : $conf->global->TEST_MYOBJECT_ADDON).'.php'
