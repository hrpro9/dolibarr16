...
/**
 * 	\defgroup   cheque     Module Cheque
 *  \brief      Cheque module descriptor.
 *
 *  \file       htdocs/cheque/core/modules/modCheque.class.php
 *  \ingroup    cheque
 *  \brief      Description and activation file for module Cheque
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module Cheque
 */
class modCheque extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Module label (no space allowed), used if translation string 'ModuleChequeName' not found (Cheque is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// Module description, used if translation string 'ModuleChequeDesc' not found (Cheque is name of module).
		$this->description = "ChequeDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "ChequeDescription";
		...
		// Key used in llx_const table to save module status enabled/disabled (where CHEQUE is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/cheque/css/cheque.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/cheque/js/cheque.js.php',
			),
		...
		// Example: this->dirs = array("/cheque/temp","/cheque/subdir");
		$this->dirs = array("/cheque/temp");

		// Config pages. Put here list of php page, stored into cheque/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@cheque");
		...
		$this->langfiles = array("cheque@cheque");
		...
		//$this->automatic_activation = array('FR'=>'ChequeWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('CHEQUE_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('CHEQUE_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isset($conf->cheque) || !isset($conf->cheque->enabled)) {
			$conf->cheque = new stdClass();
			$conf->cheque->enabled = 0;
		}
...
// 		$this->tabs[] = array('data'=>'objecttype:-tabname:NU:conditiontoremove');                                                     										// To remove an existing tab identified by code tabname
		...
		$this->dictionaries=array(
			...
			'tabcond'=>array($conf->cheque->enabled, $conf->cheque->enabled, $conf->cheque->enabled),
		...
		*/
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in cheque/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'chequewidget1.php@cheque',
			//      'note' => 'Widget provided by Cheque',
		...
		$this->cronjobs = array(
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => '$conf->cheque->enabled',
			//      'priority' => 50,
			//  ),
		);
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'$conf->cheque->enabled', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'$conf->cheque->enabled', 'priority'=>50)
		// );
		...
		*/
        ...
        $this->menu[$r++]=array(
            ...
            'langs'=>'cheque@cheque',
            'position'=>1100+$r,
            // Define condition to show or hide menu entry. Use '$conf->cheque->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            'enabled'=>'$conf->cheque->enabled',
            // Use 'perms'=>'$user->rights->cheque->level1->level2' if you want your menu with a permission rules
            'perms'=>'1',
            'target'=>'',
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'cheque');
		$result = $this->_load_tables('/cheque/sql/');
		if ($result < 0) {
		...
		//$result1=$extrafields->addExtraField('cheque_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'cheque@cheque', '$conf->cheque->enabled');
		//$result2=$extrafields->addExtraField('cheque_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'cheque@cheque', '$conf->cheque->enabled');
		//$result3=$extrafields->addExtraField('cheque_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'cheque@cheque', '$conf->cheque->enabled');
		//$result4=$extrafields->addExtraField('cheque_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'cheque@cheque', '$conf->cheque->enabled');
		//$result5=$extrafields->addExtraField('cheque_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'cheque@cheque', '$conf->cheque->enabled');
