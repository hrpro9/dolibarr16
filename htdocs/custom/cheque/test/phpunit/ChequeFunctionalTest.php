...
/**
 * \file    test/phpunit/ChequeFunctionalTest.php
 * \ingroup cheque
 ...
 * @package Testcheque
 */
class ChequeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/cheque/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('cheque/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/cheque/admin/about.php');
		$this->authenticate();
		return $this->assertContains('cheque/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('chequewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCheque_ChequeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCheque_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
