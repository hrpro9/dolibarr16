...
llxHeader("", "Etat Mensuel IR");
$text = "Etat Mensuel IR";
...
$upload_dir = DOL_DATA_ROOT . '/grh/Etats/IR';
$permissiontoadd = 1;
$donotredirect = 1;
...
print '<div style="text-align: center;">
    <h3>Etat Mensuel Impôt sur les Revenus (I.R.) Mois de ' . $french_months[$prev_month - 1] . ' ' . $prev_year . '</h3>';
...
$table .= '<tr class="row-bordered row-content">
    ...
    <td>' . price(array_sum(array_column($users, 'netImposable'))) . '</td>
    <td>' . price(array_sum(array_column($users, 'ir'))) . '</td>
</tr>';
...
function GenerateDocuments()
{
    ...
    print '<input type="hidden" name="model" value="EtatMensuelIR">';
...
function ShowDocuments()
{
    ...
    $subdir = '';
    $filedir = DOL_DATA_ROOT . '/grh/Etats/IR/'.$subdir;
    ...
    print $formfile->showdocuments('EtatMensuelIR', $subdir, $filedir, $urlsource, $genallowed, $delallowed, $modelpdf, 1, 0, 0, 40, 0, 'remonth=' . $month . '&amp;reyear=' . $prev_year, '', '', $societe->default_lang);
