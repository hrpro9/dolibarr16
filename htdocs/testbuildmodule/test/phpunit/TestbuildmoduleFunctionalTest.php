...
/**
 * \file    test/phpunit/TestbuildmoduleFunctionalTest.php
...
/**
 * Class TestbuildmoduleFunctionalTest
 *
 ...
 *
 * @package Testtestbuildmodule
 */
class TestbuildmoduleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTestbuildmodule')->click();
		} else {
			// Disable the module
			$this->byHref('modTestbuildmodule')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/testbuildmodule/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('testbuildmodule/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/testbuildmodule/admin/about.php');
		$this->authenticate();
		return $this->assertContains('testbuildmodule/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('testbuildmodulewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTestbuildmodule_TestbuildmoduleTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTestbuildmodule_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
