	...
	public function write_file($object, $outputlangs = '', $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams)
	{
		...
		if (true) {
			...
			if (file_exists($dir)) {
				...
				// 		$pdf->setPrintFooter(false);
				// 	} else {
				// 		// Handle the case where neither Imagick nor GD extension is loaded
				// 		// You can display an error message or use alternative image handling methods
				// 		echo 'TCPDF requires the Imagick or GD extension to handle PNG images with alpha channel.';
				// 	}
				// }
				...
				// body
				$table = '<table><tr><td>Cell 1</td><td>Cell 2</td></tr></table>'; // Replace with your actual table HTML
