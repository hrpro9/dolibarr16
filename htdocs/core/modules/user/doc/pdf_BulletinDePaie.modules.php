	...
	public function write_file($object, $outputlangs = '', $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if (1) {
			...
			if (file_exists($dir)) {
				...
				if ($type == "mensuel") {
					$bulttin .= '<tr class="row-content"><td class="right-td">' . getRebrique("salaireMensuel") . '</td><td>SALAIRE MENSUEL</td><td></td><td  class="right-td">' . price($object->salary) . '</td><td  class="right-td"> ' . $Taux . ' </td><td  class="right-td"> ' . price($bases["salaire mensuel"]) . ' </td><td>&nbsp;</td></tr>';
				}

				if ($type == "horaire") {
					$bulttin .= '<tr class="row-content"><td class="right-td">' . getRebrique("salaireHoraire") . '</td><td>SALAIRE HORAIRE</td><td>' . $workingHours . '</td><td>' . price($object->thm) . '</td><td>  </td><td> ' . price($bases["salaire mensuel"]) . ' </td><td>&nbsp;</td></tr>';
				}
				...
				if ($primeDancien > 0) {
					$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
						 <tr class="row-content"><td class="right-td">' . getRebrique("primeDancien") . '</td><td>PRIME D\'ANCIENNETE</td><td>&nbsp;</td><td class="right-td">' . price($bases["salaire mensuel"]) . '</td><td class="right-td">' . $primeDancienPercentage . '%</td><td class="right-td">' . price($primeDancien) . '</td><td>&nbsp;</td></tr> ';
				}

				if ($soldeConge > 0) {
					$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
					<tr class="row-content"><td class="right-td">' . getRebrique("congesPayes") . '</td><td>CONGE PAYE</td><td>&nbsp;</td><td class="right-td">' . price($bases["salaire de base"]) . '</td><td class="right-td">' . $congeDays . '</td><td class="right-td"> ' . price($soldeConge) . ' </td><td>&nbsp;</td></tr>';
				}

				if ($soldeferie > 0) {
					$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
					<tr class="row-content"><td class="right-td">' . getRebrique("joursferie") . '</td><td>LES JOURS FERIE</td><td>&nbsp;</td><td class="right-td">' . price($bases["salaire de base"]) . '</td><td class="right-td">' . $joursFerie . '</td><td class="right-td"> ' . price($soldeferie) . ' </td><td>&nbsp;</td></tr>';
				}

				foreach ($hrs as $hr) {
					$bulttin .= '<tr class="row-content"><td class="right-td">' . $hr["rub"] . '</td><td>' . $hr["designation"] . '</td><td class="right-td">' . $hr["nombre"] . '</td><td class="right-td">' . price($hr["base"]) . '</td><td class="right-td">' . $hr["taux"] . '%</td><td class="right-td"> ' . price($hr["apayer"]) . ' </td><td class="right-td" >' . $hr["aretenu"] . '</td></tr>';
				}
				...
				foreach ($enBruts as $enBrut) {
					if ($enBrut["surbulletin"] == 1) {
						...
						$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
						$bulttin .= '<tr class="row-content"><td class="right-td">' . $enBrut["rub"] . '</td><td>' . $enBrut["designation"] . '</td><td class="right-td">' . $enBrut["number"] . '</td><td class="right-td">' . $base . '</td><td class="right-td">' . $enBrut["taux"] . '</td><td class="right-td"> ' . price($enBrut["apayer"]) . ' </td><td class="right-td">' . $enBrut["aretenu"] . '</td></tr>';
					}
				}
				...
				if ($primeCommercial > 0) {
					$base = $CA > 0 ? price($CA) : "";
					$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
					$bulttin .= '<tr class="row-content"><td class="right-td">' . getRebrique("primeCommercial") . '</td><td>PRIME COMMERCIAL</td><td></td><td class="right-td">' . $base . '</td><td class="right-td">' . $percent . '%</td><td class="right-td"> ' . price($primeCommercial) . ' </td><td>&nbsp;</td></tr>';
				}

				$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr class="row-content"><td></td><td>SALAIRE BRUT</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td  class="right-td"> ' . price($brutGlobal) . ' </td><td>&nbsp;</td></tr>
				...
				foreach ($cotisations as $cotisation) {
					if ($cotisation["surbulletin"] == 1) {
						...
						$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
						$bulttin .= '<tr class=""><td class="right-td">' . $cotisation["rub"] . '</td><td>' . $cotisation["designation"] . '</td><td class="right-td">' . $cotisation["number"] . '</td><td class="right-td">' . $base . '</td><td class="right-td">' . $cotisation["taux"] . '</td><td class="right-td"> ' . $cotisation["apayer"] . ' </td><td class="right-td">' . price($cotisation["aretenu"]) . '</td></tr>';
					}
				}
				...
				if ($chargeFamille != 0) {
					$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
					$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
					$bulttin .= '<tr class="row-content"><td class="right-td">' . getRebrique("chargefamille") . '</td><td>CHARGE DE FAMILLE</td><td>&nbsp;</td><td>&nbsp;</td><td class="right-td">' . $chargeFamilleTaux . '</td><td class="right-td">' . $chargeFamille . '</td><td>&nbsp;</td></tr>';
				}

				if ($irNet > 0) {
					$bulttin .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
					<tr class="row-content"><td class="right-td">' . getRebrique("ir") . '</td><td>IR</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="right-td"> ' . price($irNet) . ' </td></tr>';
					$bulttin .= '<tr><td></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
				}
				...
				foreach ($pasEnBruts as $pasEnBrut) {
					if ($pasEnBrut["surbulletin"] == 1) {
						...
						$bulttin .= '<tr><td></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
						$bulttin .= '<tr class="row-content"><td class="right-td">' . $pasEnBrut["rub"] . '</td><td>' . $pasEnBrut["designation"] . '</td><td class="right-td">' . $pasEnBrut["number"] . '</td><td class="right-td">' . $base . '</td><td class="right-td">' . $pasEnBrut["taux"] . '</td><td class="right-td"> ' . price($pasEnBrut["apayer"]) . ' </td><td class="right-td">' . $pasEnBrut["aretenu"] . '</td></tr>';
					}
				}
				...
				<tr><td></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr><td></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr class="center-row"><td></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td></td><td class="importent-cell row-bordered"> ' . price($totalBrut) . ' </td><td class="importent-cell row-bordered"> ' . price($totalRetenu) . ' </td></tr>
				<tr class="center-row"><td></td><td>&nbsp;</td><td class="importent-cell row-bordered" colspan="3">Net a payer</td><td class="importent-cell row-bordered" colspan="2"> ' . price($totalNet) . ' </td></tr>
				...
				<tr class="row-bordered row-content center-row"><td></td><td>Mensuel</td><td>' . ($workingdaysdeclaré) . '</td><td>' . price($brutImposable) . '</td><td>' . price($netImposable) . '</td><td colspan="2">' . price($irNet) . '</td></tr>
				<tr class="row-bordered row-content center-row"><td></td><td>Annuel</td><td>' . ($comulWorkingDays + $workingdaysdeclaré) . '</td><td>' . price($comulsalaireBrut + $brutImposable) . '</td><td>' . price($comulnetImposable + $netImposable) . '</td><td colspan="2">' . price($comulIR + $irNet) . '</td></tr>
				</tbody>
	   			</table>';
