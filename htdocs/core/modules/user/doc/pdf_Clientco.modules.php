 ...
 */
class pdf_Clientco extends ModelePDFUser
{
	/**
	...
	public function write_file($object, $outputlangs = '', $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams)
	{
		...
		if (true) {
			...
			if (file_exists($dir)) {
				...
				$pdf->SetTitle($outputlangs->convToOutputCharset('Commande Client'));
			   ...
			   $ref=GETPOST('ref');
			   $qty=GETPOST('qty');
			   $entrpName=GETPOST('entrpName');
			   $valeur=GETPOST('valeur');
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $totalNet, $periode)
	{
		...
		$pdf->SetFont('', 'B', $default_font_size + 3);
		$pdf->MultiCell(200, 2, "Bon de retour Marchandise du Client ", 0, "C");
